...
\begin{itemize}
	...
	\item External Examiner \dotfill \\ \hfill{Dr.{\textit{Petter Pilesj\"o}\index[people]{Pilesj\"o, P.}} (Lund University, GIS Centre)}
\end{itemize}
...
\begin{itemize}
	\item[* ] Mr. \textit{Valentijn Venus}\index[people]{Venus, V.} \dotfill \\ (Department of Natural Resource, ITC)
	\item[* ] Dr. \textit{Albertus G. Toxopeus}\index[people]{Toxopeus, A.G.} \dotfill \\ (Department of Natural Resource, ITC)
\end{itemize}
...
\textit{Chapter 5}: \nameref{sec:5} summarizes and briefly discusses again the main results, reported in detail in a previous chapter. This chapter proposes some final discussions to the reader, and comes to the main research outcomes.\\
...
\begin{figure}[H]
	\centering
	\subfloat [iPAQ, HP]{\label{fig:3.3a}\includegraphics[width=0.3\textwidth]{Fig-19a.jpg}}
	\subfloat [Waterproof Otterbox for iPAQ]{\label{fig:3.3b}\includegraphics[width=0.3\textwidth]{Fig-19b.jpg}}
	\subfloat [GPS]{\label{fig:3.3c}\includegraphics[width=0.15\textwidth]{Fig-19c.jpg}}
	\subfloat [Olympus waterproof camera]{\label{fig:3.3d}\includegraphics[width=0.25\textwidth]{Fig-19d.jpg}}
...
%\appendixname{\textbf{4: \\Sampling design of the depths measurements. Ligaria beach, Crete}}
