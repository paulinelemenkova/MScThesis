...
(Liliaceae) than to the true grass, despite their name “seagrass”, caused by the ribbon-like, grassy leaves
...
This naturally increase environmental pressing and leads to drastic loss of very large areas of
...
\begin{wrapfigure}{r}{0.4\textwidth}
	...
	\caption{\textit{	extit{P.oceanica}}.\\
...
i) spectra of 	extit{P.oceanica}, carbonate sand, silt and other seafloor types
...
v) vector GIS layers.
The research aims to explore the dynamics of the environmental changes of the \textit{P.oceanica} meadows
...
analyse the environmental changes of the 	extit{P.oceanica} meadows over the last 10 years (2000-2010)
...
Crete Island
2) Monitoring the dynamics of the environmental changes of the \textit{P.oceanica} meadows over
time (2000-2010) in Ligaria beach, Agia Pelagia district.

\subsubsection{Specific objectives}
1. To apply remote sensing data (Google Earth aerial images, Landsat, SPOT satellite images)
for the monitoring of the seagrass meadows distribution
2. To study narrow-band spectral reflectance properties of \textit{P.oceanica} and other seafloor
cover types (sand and silt) using WASI water colour simulation software
3. To use methods of the in situ diving observations and underwater videometric measurements
by Olympus camera in order to receive large-scale imagery of the 	extit{P.oceanica} mattes
4. To perform images classification (supervised and unsupervised) for the thematic mapping of
the 	extit{P.oceanica} seagrass distribution along the coasts of northern Crete.
...
Spectral reflectance, distinct for each seafloor cover type, enables their discrimination on the image. The pre-processing
...
Several global seagrass surveys organise and provide regular monitoring of the seagrass distribution,
...
\begin{wrapfigure}{r}{0.4\textwidth}
	...
	\caption{In situ optical reflectance spectra of seagrass. Shaded areas - percent of spectra lying within the range of reflectance. 
...
reported, for example, by Hirose \cite{Hirose04} \label{Hirose04}. Other multispectral images have also been used for the
...
sand very well distinguishable in their spectra with an overall classification accuracy of 98 percent.
...
(36°20′N 22°59′E) and Xerocampos (35°12′N 26°18′E), at depths lesser than 4 meters. 
...
of the seagrass beds during snorkeling and SCUBA diving, recommendations from the Greek collaborators of the Natural Nistory Museum of Crete, and available maps covering the research area. To ensure even and objective selection of sampling sites
...
\subsection[Google Earth aerial imagery]{Google Earth aerial imagery for seagrass mapping}
...
manually. However, the most important, major factors affecting the in-situ conditions are water depth (Fig.\ref{fig:4.9})
...
research question: whether the 	extit{P.oceanica} spectra is spectrally distinct at varying environmental in-situ
...
\begin{table}[htbp]
	...
	\caption{Results of the statistical analysis of spectral reflectance of \textbf{P.oceanica}, with average values (for sets 1 - 350). Generalisation up to step 20 nm}\label{tab:4.1}
	\begin{center}
...
45° and reflection factor 0.0201. \textit{P.oceanica}. These values, simulating the environment of the Mediterranean Sea, are fixed (Tab.\ref{tab:3}) among WASI user-defined parameters.
...
the seagrass 	extit{P.oceanica} from other seafloor types is not changing with varying in-situ conditions,
...
spectral reflectance of 	extit{P.oceanica} to be more or less spectrally disticnt from other seafloor cover
...
of data points. Therefore, we used the data (\nameref{app}) of means of spectral reflectance of both
...
the areas. The classification is based on the spectral properties of the \textit{	extit{P.oceanica}}, such as brightness,
...
bottom types: sandy surface, seagrass bed for each species including \textit{	extit{P.oceanica}} (meadows), patchy
...
\begin{figure}
	...
	\caption{Seafloor types of the Arina beach: \textit{	extit{P.oceanica},} sand, rocks. \\ \href{http://www.google.com/earth/index.html}{Google Earth} images}
	\label{fig:38}
\end{figure}
...
\begin{figure}[h]
	...
	\subfloat [Patches (mattes) of the seagrass. Source: in-situ videometric measurements]{\label{fig:41b}\includegraphics[width=0.47\textwidth]{Fig-38b.jpg}}
...
\section{Keywords}
\markright{Keywords}
Seagrass, \textit{\textit{	extit{P.oceanica}}}, analysis of spectral reflectance, remote sensing, monitoring, Google Earth, Crete
\pagebreak
...
\begin{table}[htbp]
	...
	\caption{Model summary of the \textit{regression} analysis: curve estimation and ANOVA table tested for single observations within one measurement set: spectral 			reflectance of \textbf{	extit{P.oceanica}}. \href{http://www.spss.com/}{SPSS}}
	\begin{center}
...
\begin{table}[htbp]
	\rowcolors{1}{Ivory}{GhostWhite}
	\caption{\textit{ANOVA} table: exponential curve estimation in the regression analysis, tested for single observations within one measurement set: spectral reflectance of 		\textbf{	extit{P.oceanica}}. \href{http://www.spss.com/}{SPSS}}
	\begin{center}
...
\begin{table}[htbp]
	\rowcolors{1}{Ivory}{GhostWhite}
	\caption{Coefficients of the \textit{regression analysis} (exponential curve estimation) of the spectral reflectance of \textbf{	extit{P.oceanica}}. \href{http://www.spss.com/}{SPSS}}
	\begin{center}
...
\begin{table}[htbp]
	\rowcolors{1}{Ivory}{GhostWhite}
	\caption{Results of the \textit{ANOVA one-way} analysis: results of the \textit{single factor} (depth) testing of the radiance of \textit{	extit{P.oceanica}} at various depths: 0.5, 1.5 and 2.5 meters. \href{http://www.spss.com/}{SPSS}}\label{tab:8}
	\begin{center}
	\begin{tabular}{|c|c|c|c|c|c|c|}
		\hline\hline
...
\begin{table}[htbp]
	\rowcolors{1}{Ivory}{GhostWhite}
	\caption{Summary of the \textit{ANOVA one-way} analysis: results of the \textit{single factor} (depth) testing of the radiance of \textit{	extit{P.oceanica}} at various depths: 0.5, 1.5 and 2.5 meters. \href{http://www.spss.com/}{SPSS}}\label{tab:A.7}
	\begin{center}
	\begin{tabular}{|c|c|c|c|c|}
		\hline\hline
...
\begin{longtable}{|c|c|c|c|c|c|c|}
	\caption{Results of the statistical analysis of spectral reflectance of \textbf{	extit{P.oceanica}}, sets 1-350). Wavelength step: 3 nm. Measured on Agia Pelagia beach, 15th October}\label{tab:A.8} \\
	...
	\multicolumn{7}{c}{Table A.8: Spectral reflectance of \textbf{	extit{P.oceanica}} \textit{(continued from previous page)}}\\
...
\begin{table}[htbp]
	\rowcolors{1}{Ivory}{GhostWhite}
	\caption{Results of the \textit{autocorrelation analysis} of the measurement set 1-16 of the spectral reflectance of \textbf{	extit{P.oceanica}} (15.X.), Series:V3. \href{http://www.spss.com/}{SPSS}}
	\begin{center}
	\begin{tabular}{|c|c|c|c|c|c|}
		\hline\hline
...
\begin{figure}[H]
	...
	\caption{\textit{Autocorrelation analysis} of the measurement set 1-16 of the spectral reflectance of \textbf{	extit{P.oceanica}} (15.X.). Visualization in \href{http://www.spss.com/}{SPSS}}
	\label{fig:A.21}
\end{figure}
\pagebreak
\newpage
...
\begin{table}[htbp]
	\rowcolors{1}{Ivory}{GhostWhite}
	\caption{Results of the partial \textit{autocorrelation analysis} of the measurement set 1-16 of the spectral reflectance of \textit{	extit{P.oceanica}} (15.X.), Series:V3. \href{http://www.spss.com/}{SPSS}}\label{tab:14}
	\begin{center}
	\begin{tabular}{|c|c|c|}
		\hline\hline
...
\begin{figure}[H]
	...
	\caption{Partial correlation analysis of the measurement set 1-16 of the spectral reflectance of \textit{	extit{P.oceanica}} (15.X.). Visualization in \href{http://www.spss.com/}{SPSS}}
	\label{fig:A.22}
\end{figure}
\pagebreak
\newpage
...
\begin{table}[H]
	...
	\begin{center}
		\caption{\textit{Ordinary Least Squares}: results of the \textit{OLS} analysis of the measurement set 326-350 of the spectral reflectance of \textit{	extit{P.oceanica}} (15.X.). \href{http://gretl.sourceforge.net/}{Gretl}}
...
\begin{table}[htbp]
	\rowcolors{1}{Ivory}{GhostWhite}
	\caption{Summary of the table with values of the spectral reflectance of \textbf{	extit{P.oceanica}} measured on three different depths, R}
	\begin{center}
	\begin{tabular}{|c|c|c|c|}
		\hline\hline
...
%%% Gretl start
\begin{table}[htbp]
	\caption{\textit{Two-Stage Least Squares}: results of the \textit{TSLS} analysis of the measurement set 1-191 of the spectral reflectance of \textbf{	extit{P.oceanica}} (15.X.). \href{http://gretl.sourceforge.net/}{Gretl}}
	\begin{center}
...
\begin{table}[htbp]
	\rowcolors{1}{Ivory}{GhostWhite}
	\caption{Initial Cluster Centers: results of the \textit{K-means} analysis of the measurement set 201-236 of the spectral reflectance of \textbf{	extit{P.oceanica}} (15.X.).  \href{http://www.spss.com/}{SPSS}}
	\label{tab:13}
	\begin{center}
	\begin{tabular}{|c|c|c|c|c|c|}
		\hline\hline
...
\begin{table}[htbp]
	\rowcolors{1}{Ivory}{GhostWhite}
	\caption{Iteration History(a): results of the \textit{K-means} analysis of the measurement set 201-236 of the spectral reflectance of \textbf{	extit{P.oceanica}} (15.X.).  \href{http://www.spss.com/}{SPSS}}
	\begin{center}
	\begin{tabular}{|c|c|c|}
		\hline\hline
...
\begin{table}[H]
	\rowcolors{1}{Ivory}{GhostWhite}
	\caption{Number of Cases in each Cluster: results of the \textit{K-means} analysis of the measurement set 201-236 of the spectral reflectance of \textbf{	extit{P.oceanica}} (15.X.).  \href{http://www.spss.com/}{SPSS}}
		\begin{center}
		\begin{tabular}{|c|c|}
		\hline\hline
...
\begin{table}[htbp]
	\rowcolors{1}{Ivory}{GhostWhite}
	\caption{Final Cluster Centers: results of the \textit{K-means} analysis of the measurement set 201-236 of the spectral reflectance of \textbf{	extit{P.oceanica}} (15.X.).  \href{http://www.spss.com/}{SPSS}}
	\begin{center}
	\begin{tabular}{|c|c|c|c|c|c|}
	\hline\hline
		& \multicolumn{2}{|c|}{Cluster} &  & \multicolumn{2}{|c|}{Cluster}\\
...
%%%Gretl begin
\begin{table}[H]
	\caption{Results of the \textit{Principal Components Analysis}: measurement variables 1-7 from the selected dataset 301-325 of the spectral reflectance of \textbf{	extit{P.oceanica}} (15.X.). \href{http://gretl.sourceforge.net/}{Gretl}}
	\begin{center}
...
\begin{table}[H]
	\begin{center}
		...
		\caption{Results of the \textit{tobit analysis} with censored dependent variable (2) from the selected dataset Series 151-175 of the s.reflectance of \textbf{	extit{P.oceanica}}. \href{http://gretl.sourceforge.net/}{Gretl}}
...
\begin{table}[H]
	...
	\begin{center}
	\caption{Results of the \textit{Prais-Winsten estimation} applied towards variables 15 from the selected dataset 151-175 of the spectral reflectance of \textbf{	extit{P.oceanica}}. \href{http://gretl.sourceforge.net/}{Gretl}}
	\label{tab:26}
...
\begin{table}[H]
	\begin{small}
	\rowcolors{1}{Ivory}{LightGoldenrodYellow}
	\caption{Results of the \textit{periodogram} for v30 of the measurement set 51-75 of the spectral reflectance of \textbf{carbonate sand}, \href{http://gretl.sourceforge.net/}{Gretl}}
	\label{tab:30}
	\begin{center}
