...
Various global seagrass survey organizations \index[concepts]{Seagrasses!global surveys} organize and provide regular monitoring of the seagrass species distribution, health and environmental sustainability. \\ We list below the most known seagrass research institutions: 
\begin{itemize}
...
UVA/UVB Irradiance Sensor and \ac{Trios-RAMSES}-ARC Hyperspectral UV-VIS Radiance Sensor (Fig. \ref{fig:2.1}), both adjusted for the measurements of the irradiance and radiance (see \nameref{app}: Tab. \ref{tab:A.1}, Tab. \ref{tab:A.2}). \\
...
types, where the spectral signatures were examined. WASI software\index[concepts]{Seawater optical properties!RTM!WASI} (Fig.\ref{fig:4.7}) is used to simulate
...
An analysis of the spectral reflectance of \textit{P.oceanica} is done using the WASI simulations\index[concepts]{Seawater optical properties!RTM!WASI} in order to
...
spectral signatures using WASI software\index[concepts]{Seawater optical properties!RTM!WASI}, image processing by means of Erdas Imagine (Fig.\ref{fig:39}) and Arc GIS based mapping. The use of GIS for data incorporation (Fig.\ref{fig:4.17}), storage, analyses, visualizing and mapping
