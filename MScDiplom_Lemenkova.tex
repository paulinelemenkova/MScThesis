...
at each data set (for example, Fig.\ref{fig:A.11}) with summary outcome of mean, median, Q1 and Q3, standard deviation, min and max values (Tab.\ref{tab:4}, Tab.\ref{tab-16}).\label{page-sumstat} 
...
To estimate spectral density of a spectral reflectance measurements we used periodogram\index[concepts]{Data!statistical analysis!periodogram} function (Tab.\ref{tab:30})\label{page-period}, which corresponds to the general spectrum of the observations with representation of a variable quantity.  
Thus, the periodogram (Fig.\ref{fig:A.31})\label{page-A31} of the series of observation\index[concepts]{Data!statistical analysis!observations, series of} highlights so-called “dead spots” of low power between the frequencies we wish to exclude (can be seen clearly at the end of the graphs, e.g. Fig.\ref{fig:A.12} ) 
