...
An Index is placed in the end of the Document to help the reader find what he is looking for.
...
Several global seagrass surveys\index[concepts]{Seagrasses!global surveys} organize and provide regular monitoring of the seagrass distribution,
...
Studies of spectral reflectance\index[concepts]{Seawater optical properties!spectral reflectance} of the different seagrass species comparing to the spectra of sand and
...
The most important spectral diapason\index[concepts]{Seawater optical properties!spectral reflectance!spectral diapason} for marine mapping of submerged vegetation
...
Another well-known multispectral sensor, \ac{SPOT}\index[concepts]{Remote sensing!multispectral imagery!SPOT} provides multispectral imagery with a spatial
...
remote sensing sensors (\ac{MODIS}, \ac{ASTER}, \ac{MERIS} and \ac{SeaWiFS}), (Fig.\ref{fig:4.6}).
...
\begin{figure}[H]
	...
	\subfloat [\textit{	extit{P.oceanica}}]{\label{fig:34b}\includegraphics[width=0.4\textwidth]{Fig-27b.jpg}}
