...
\usepackage[a4paper, left=30mm,right=25mm,top=30mm,bottom=35mm]{geometry}
%\usepackage{glossary}
\usepackage{graphics}
\usepackage{graphicx}
...
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering
	\includegraphics[scale=0.30]{Fig-1-2.jpg}
...
spectral signatures using WASI software\index[concepts]{Seawater optical properties!RTM!WASI}, image processing by means of Erdas Imagine (Fig.\ref{fig:39}) and Arc GIS
...
\subsubsection{Upscale mapping of the seagrass landscapes}\index[concepts]{concepts}{Seagrasses!spatial structure}
...
papers/0611/0611006.pdf}{arxiv.org} \pageref{Diaz-Almela06}
\bibitem{Dierssen03}
Dierssen H.\index[people]{} and Zimmerman R.C.\index[people]{} 2003. \emph{Ocean color remote sensing of seagrass and
...
\bibitem{Dixon05}
Dixon R.\index[people]{}, editor. 2005. \emph{Watching the Seagrass Grow – a guide for community seagrass
