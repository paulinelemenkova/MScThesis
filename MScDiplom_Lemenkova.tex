...
\begin{itemize}
	\item Name Examiner 1 (Chair) \hfill{Prof. Dr. \textit{Andrew K. Skidmore}\index[people]{Skidmore A.K.} (ITC, Department of Natural Resource)}
	\item Name Examiner 2 \hfill{Ms. Ir. \textit{Louise M. van Leeuwen}\index[people]{Leeuwen, L. M. van} (ITC, Department of Natural Resource)}
	\item External Examiner \hfill{Dr. {\textit{Ma\l{}gorzata Roge-Wi\'sniewska}\index[people]{Roge-Wi\'sniewska, M.}} (University of Warsaw, Faculty of Geography and Regional Studies)}
\end{itemize}
...
\begin{itemize}
	\item[* ] Mr. \textit{Valentijn Venus}\index[people]{Venus, V.}  \hfill{(University of Twente, ITC, Department of Natural Resource)}
	\item[* ] Dr. \textit{Albertus G. Toxopeus}\index[people]{Toxopeus, A.G.}  \hfill{(University of Twente, ITC, Department of Natural Resource)}
\end{itemize}
...
\subsection{Hypotheses testing}\index[concepts]{Research!questions!hypothesis}
...
\subsection{Research assumptions}\index[concepts]{Research!assumptions}
The wind roughening the water surface causes sun glitter, and the values spectral reflectance may contain disturbances and noisy if the solar zenith angle is too high, say approaching 60-70 degrees. Therefore, the measurements should be made at midday (noon) with as low zenith angle (Fig.\ref{fig:A.2-1})\label{zenith} as possible.
\pagebreak
...
We briefly discuss below the most effective RTM software and algorithms from a range of various best-known up-to-date tools. 
	\begin{itemize}
		...
		\item [*] A \ac{DISORT}\index[concepts]{Seawater optical properties!RTM!DISORT}  is another RTM freeware , developed as an algorithm for calculation radiance of the scattering and absorbing Earth's atmosphere and transmissivity computations within the waveband range from UV to radar.  
...
\subsection[Application of the remote sensing...]{Application of the remote sensing data towards seagrass mapping}\index[concepts]{Remote sensing}
...
\begin{wrapfigure}{r}{0.4\textwidth}
	...
	\caption{\textit{In situ} optical reflectance spectra of seagrass. Shaded areas - \% of spectra lying within the range of reflectance. 
		White lines - mean spectra. Source: \cite{Hochberg03b}\label{Hochberg03b}. Page: $<$\pageref{page-21}$>$}
	\label{fig:13}
\end{wrapfigure}
...
Spectral reflectance\index[concepts]{Seawater optical properties!spectral reflectance} of the seagrass  (Fig.\ref{fig:13}) is largely influenced by the water
...
\subsubsection[Review of multispectral imagery...]{Review of multispectral imagery used for seagrass mapping}\label{sec:2.4.1}\index[concepts]{Remote sensing!multispectral imagery} 
...
\subsubsection[Review of hyperspectral imagery...]{Review of hyperspectral imagery used for seagrass mapping}\label{sec:2.4.2}\index[concepts]{Remote sensing!hyperspectral imagery}
...
\begin{figure}[H]
	...
	\caption{Fieldwork equipment. Pages: $<$\pageref{page-15}$>$, $<$\pageref{page-24}$>$, $<$\pageref{page-25}$>$}
	\label{fig:3.3}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Scheme of placements of the Olimpus cameras during the measurements. Page: $<$\pageref{page-26}$>$}
	\label{fig:3.5}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Locations of the video measurements and GPS tracklogs, Ligaria. Page: $<$\pageref{page-25}$>$}
	\label{fig:3.6}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Statistical comparison of spectral reflectance of \textit{P.oceanica} and carbonate sand. Selected measurements sets. \href{http://www.gnuplot.info/}{Gnuplot} graph. Page: $<$\pageref{page-47}$>$}
	\label{fig:28}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Optical properties of the sea water with sediments, measured in aquarium tank. Agia Pelagia district, Crete. \href{http://www.gnuplot.info/}				{Gnuplot}. Page: $<$\pageref{page-21}$>$}\label{fig:4.2}
\end{figure}
...
\begin{wrapfigure}{r}{0.5\textwidth}
	...
	\caption{Combined plots of simulated remote sensing reflectance of \textit{P.oceanica} at various sensors: \ac{MODIS}, \ac{MERIS}, \ac{SeaWiFS} and \ac{CZCS}, iterated over three depths. Page: $<$\pageref{page-21}$>$}
	\label{fig:4.6}
\end{wrapfigure}
...
\subsubsection{Water color spectral simulation using WASI}\index[concepts]{Data!processing}\label{page-35}
...
\begin{figure}[h]
	...
	\caption{Main interface of \ac{WASI} water color spectral simulation: \\ Spectral reflectance of \textit{P.oceanica} and silt at 0.5-4.0m. Page: $<$\pageref{page-35}$>$}
	\label{fig:4.7}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Remote sensing reflectance of \textit{P.oceanica} at various depths, simulated for broadband sensors. Page: $<$\pageref{page-37}$>$}
	\label{fig:4.9}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Statistical analysis of the spectral reflectance of \textit{P.oceanica}: min-max, average values (red bold points), Q1-Q3 areas (green vertical dashed) and 	measured values (dotted): multiplot of measurement sets 200-300. \href{http://www.gnuplot.info/}{Gnuplot}. Pages: $<$\pageref{page-21}$>$, $<$\pageref{page-37}$>$}
	\label{fig:4.10}
\end{figure}
\begin{figure}[H]
	\centering
	\subfloat [Sand]{\label{fig:34a}\includegraphics[width=0.4\textwidth]{Fig-27a.jpg}}
	\subfloat [\textit{P.oceanica}]{\label{fig:34b}\includegraphics[width=0.4\textwidth]{Fig-27b.jpg}}
...
The \ac{LAD}\index[concepts]{Data!statistical analysis!LAD}, a popular optimization technique, were used to show the main trend of the distribution of spectral reflectance values along the spectra (Tab.\ref{tab:12}). Non-linear logistic analysis\index[concepts]{Data!statistical analysis!non-linear logistic analysis} is applied to specify and estimate a model of spectral distribution, in which the dependent variable (i.e. the value of spectral reflectance for each single observation) is not continuous, but discrete and independent for each case (Tab.\ref{tab:11}). \\
...
To estimate spectral density of a spectral reflectance measurements we used periodogram\index[concepts]{Data!statistical analysis!periodogram} function (Tab.\ref{tab:30}), which corresponds to the general spectrum of the observations with representation of a variable quantity.  
Thus, the periodogram (Fig.\ref{fig:A.31}) of the series of observation\index[concepts]{Data!statistical analysis!observations, series of} highlights so-called “dead spots” of low power between the frequencies we wish to exclude (can be seen clearly at the end of the graphs, e.g. Fig.\ref{fig:A.12} ) 
...
areas of quartiles\index[concepts]{Data!statistical analysis!quartiles Q1-Q3} (Q1, Q3, shaded areas on graph, Fig. \ref{fig:4.10}, Fig.\ref{fig:4.14}), which cover most probable data distribution (spectral reflectance) for each spectral band. In x-axis displayed are the areas of 400 – 950 nm in
...
\paragraph{Student-t testing}\index[concepts]{Data!statistical analysis!Student-t testing}
...
\begin{figure}
	\centering
	\subfloat [small-scaled (1:54,000)]{\label{fig:38a}\includegraphics[width=0.8\textwidth]{Fig35a.jpg}}\\
	\subfloat [enlarged (1:10,000)]{\label{fig:38b}\includegraphics[width=0.8\textwidth]{Fig35b.jpg}}
...
\subsubsection{Data integration}\index[concepts]{Data!integration}
...
spectral signatures using \ac{WASI} software\index[concepts]{Seawater optical properties!RTM!WASI}, image processing by means of Erdas Imagine (Fig.\ref{fig:39}, Fig.\ref{fig:42}) and Arc \ac{GIS} based mapping. The use of \ac{GIS} for data incorporation (Fig.\ref{fig:4.17}), storage, analyses, visualizing and mapping
...
\subsubsection{Upscale GIS mapping of the seagrass landscapes}\index[concepts]{Seagrasses!spatial structure}\label{page-48}
...
The finding of \textit{Chapter 4}, \nameref{sec:4} showed that the relationship between the spectral reflectance of various seafloor cover types was tied to depth, i.e. water column height. Thus, the results of the in-situ fieldwork measurements revealed that spectral reflectance of \textit{P.oceanica} undergo alterations at depths of 0.5, 2.0 and 3.5m (Fig.\ref{fig:4.9}). These results indicate that seagrass \textit{P.oceanica} can in general be detected and discriminated from other seafloor cover types with varying environmental conditions, i.e. water column height, by hyperspectral spectroradiometers (\ac{Trios-RAMSES}), which positively answers the \textbf{first research question} of this thesis (``Is \textit{P.oceanica} spectrally distinct from other seafloor cover types with varying in-situ conditions ?"). \vspace{1ex}\\
...
For further development of the  remote sensing based monitoring and mapping of the seagrass and other seafloor cover types it is desirable to consider the substratum and underwater relief in a more detailed way, i.e. bathymetric properties of the testing sizes, because changes in relief directly cause and reinforce the colonisation process of \textit{P.oceanica} meadows. Thus, the depression and valleys in relief in general stimulate increase of the sedimentation process. In turn, it enables accumulation of necessary nutrient for seagrass plant growth, increases resource allocation to the seagrass roots for better exploitation of pore-water nutrients by the \textit{P.oceanica} shoots. As for patchiness in seagrass landscapes, besides natural reasons, the anthropogenic disturbances (e.g. ocean trawling) still remain a main cause for landscapes fragmentation.
\pagebreak
...
\subsection{\footnote{The page where the illustration is explained in the main text of MSc thesis is given in angle brackets (e.g., $<$10$>$).} Capturing aerial imagery from the Google Earth}
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Ligaria beach, Crete: seafloor types. Page: $<$\pageref{page-39}$>$}\label{fig:A.5}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Various seafloor types; Ligaria beach, Crete}\label{fig:A.6}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Fragment of \textit{Bottom.R} file: values of spectral measurements of the
		seagrasses (various species), sand, silt and artificial spectrum of constant albedo. Page: }
	\label{fig:A.9}
\end{figure}
\pagebreak
...
\begin{figure}[H]
	...
	\caption{Multiplot graph showing spectral reflectance of the seawater without sediments, measured in aquarium tank, Agia Pelagia district, Crete. \href{http://www.gnuplot.info/}{Gnuplot}. Two complimentary graphs below show the results of the statistical analysis. Page: $<$\pageref{page-35}$>$}
	\label{fig:27}
\end{figure}
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.20]{App-1.jpg}
		\caption{Values of spectral reflectances of seagrass \textit{P.oceanica} (fragment). Page: $<$\pageref{page-40}$>$}
		\label{fig:A.11}
	\end{center}
\end{figure}
\begin{figure}[H]
	\begin{center}
		...
		\caption{Spectral reflectance of \textit{P.oceanica}. Measurement series 401-420. \href{http://www.gnuplot.info/}{Gnuplot}. Page: $<$\pageref{page-21}$>$}
		\label{fig:A.12}
	\end{center}
\end{figure}
\begin{figure}[H]
	\begin{center}
		...
		Visualization of the interquartile ranging. Example of data set 401-420. Shown mid-spread of  statistical quartiles Q1 and Q3, min and max values within the range. \href{http://www.gnuplot.info/}{Gnuplot}. Page: $<$\pageref{page-21}$>$}
		\label{fig:A.13}
	\end{center}
\end{figure}
\begin{figure}[H]
...
\begin{figure}[H]
	...
	\caption{Fragment of the statistical analysis of the \textit{P.oceanica} reflectance. Example of data set 401-420. 
		Visualization of the measured data together with statistical values: interquartile ranging, medians, means. \href{http://www.gnuplot.info/}{Gnuplot}. Page: $<$\pageref{page-21}$>$}
	\label{fig:A.15}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Radiance of the seawater with sediments. Measured in aquarium tank. Bezier Interpolation. \href{http://www.gnuplot.info/}{Gnuplot}. Page: $<$\pageref{page-40}$>$}
	\label{fig:A.16}
\end{figure}
...
\begin{longtable}{|c|c|c|c|c|c|c|}
	\caption{Results of the statistical analysis of spectral reflectance of \textit{P.oceanica}, sets 1-350). Wavelength step: 3 nm. Measured on Agia Pelagia beach, 15th October. Page: $<$\pageref{page-40}$>$}\label{tab:A.8} \\
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Irradiance of the seawater, measured in aquarium tank. Smooth Splines interpolation. Visualization in \href{http://www.gnuplot.info/}{Gnuplot}­}
		\label{fig:A.17}
	\end{center}
\end{figure}
\begin{figure}[H]
	...
	\caption{Irradiance of the seawater, measured in aquarium tank. Smooth Bezier interpolation. Visualization in \href{http://www.gnuplot.info/}{Gnuplot}}
	\label{fig:A.18}
\end{figure}
\pagebreak
\newpage
\begin{figure}[H]
	\begin{center}
		...
		\caption{Frequency normality test against gamma distribution: radiance of the seawater, measured in aquarium tank. Visualization in \href{http://gretl.sourceforge.net/}{Gretl}}
		\label{fig:A.19}
	\end{center}
\end{figure}
\begin{figure}[H]
	...
	\caption{Frequency normality test against normal distribution: radiance of the seawater, measured in aquarium tank. Visualization in \href{http://gretl.sourceforge.net/}{Gretl}­}
	\label{fig:A.20}
\end{figure}
...
\begin{table}[H]
	\rowcolors{1}{Ivory}{GhostWhite}
	\caption{Results of the \textit{autocorrelation analysis} of the measurement set 1-16 of the spectral reflectance of \textit{P.oceanica} (15.X.), Series:V3. \href{http://www.spss.com/}{SPSS}}
	\begin{center}
	\begin{tabular}{|c|c|c|c|c|c|}
		\hline\hline
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Spectral reflectance of the seawater with sediments. Bezier interpolation. Mean value is shown by the vertical impulses linestyle. \href{http://www.gnuplot.info/}{Gnuplot}­}
		\label{fig:A.23}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Spectral reflectance of \textit{P.oceanica}. Measurement series 25-50. \\ \href{http://www.gnuplot.info/}{Gnuplot} display. Page: $<$\pageref{page-21}$>$­}
		\label{fig:A.25}
	\end{center}
\end{figure}
\pagebreak
...
\begin{table}[H]
	\rowcolors{1}{Ivory}{GhostWhite}
	\caption{Initial Cluster Centers: results of the \textit{K-means} analysis of the measurement set 201-236 of the spectral reflectance of \textit{P.oceanica} (15.X.).  \href{http://www.spss.com/}{SPSS}.  Page: $<$\pageref{page-41}$>$}
	\label{tab:13}
	\begin{center}
	\begin{tabular}{|c|c|c|c|c|c|}
		\hline\hline
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Multiplot of spectral reflectance of \textit{P.oceanica}. Series 151-200. Shown mid-spread of the statistical quartiles Q1 and Q3 (vertical dashes) and mean value within the range (red bold dots). \href{http://www.gnuplot.info/}{Gnuplot} visualization­. Page: $<$\pageref{page-39}$>$}
		\label{fig:A.28}
	\end{center}
\end{figure}
\pagebreak
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Plot illustrating polynomial trend for spectral reflectance of seawater with sediments (Ligaria Beach), variable V15. \href{http://gretl.sourceforge.net/}{Gretl} modelling visualization­}
	\end{center}
	\label{fig:A.33}
\end{figure}
\begin{figure}[H]
	\begin{center}
		...
		\caption{Exponential moving average of spectral reflectance of seawater with sediments (Ligaria Beach), variable V15. \href{http://gretl.sourceforge.net/}{Gretl} modelling visualization­}
	\end{center}
	\label{fig:A.34}
\end{figure}
\pagebreak
...
\begin{longtable}{|r|r|r|r|r|r|r|}
	\caption{Results of the statistical analysis of spectral reflectance of \textbf{carbonate sand}, with average values (for sets 1-3). Wavelength step: 3 nm. Measured on Agia Pelagia beach, 14th October. Page: $<$\pageref{page-40}$>$}\label{tab:A.29} \\
 		 \multicolumn{1}{|l|}{\textbf{wl}} &
  		 \multicolumn{1}{l|}{\textbf{min}} & 
  		 \multicolumn{1}{l|}{\textbf{Q1}} & 
  		 \multicolumn{1}{l|}{\textbf{mean}} & 
...
\begin{figure}[H]
	...
	\caption{Spectral reflectance of carbonate sand on A.Pelagia beach. Results of single measurement set made by spectroradiometer Trios-RAMSES. \href{http://www.gnuplot.info/}{Gnuplot}. Page: $<$\pageref{page-39}$>$}
	\label{fig:A.35}
\end{figure}
\pagebreak
\newpage
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Random mosaic of selected aerial Google Earth images. Page: $<$\pageref{page-47}$>$}\label{fig:A.37}	
	\end{center}	
\end{figure}
\pagebreak
...
\begin{figure}[H]
	...
	\caption{SCUBA gear diving equipment necessary for seagrass monitoring. Source: \href{http://divinginstructortraining.com/}{Aquanauts.com}. Page: $<$\pageref{page-25}$>$}
	\label{fig:A.52}
\end{figure}
\begin{figure}[H]
	\centering
...
\begin{figure}[H]
	...
	\caption{Monitoring different seafloor cover types: mattte of \textit{P.oceanica} vs carbonate sand. Ligaria beach.}
	\label{fig:A.56}
\end{figure}
...
\bibitem{Dekker05b}
Dekker A.\index[people]{Dekker A.G.}, Brando V.E.\index[people]{Brando V.E.}, Anstee J.M.\index[people]{Anstee J.M.} 2005. \emph{Remote Sensing of Seagrass Ecosystems: Use of Spaceborne and Airborne Sensors}. SVNL083-Larkum. \pageref{05b}
\bibitem{DiCarlo04}
