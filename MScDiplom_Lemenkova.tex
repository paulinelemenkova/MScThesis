...
\begin{figure}[h]
	\centering
	\subfloat [iPAQ, HP]{\label{fig:20a}\includegraphics[width=0.3\textwidth]{Fig-19a.jpg}}
	\subfloat [Waterproof Otterbox for iPAQ]{\label{fig:20b}\includegraphics[width=0.3\textwidth]{Fig-19b.jpg}}
	\subfloat [GPS]{\label{fig:20c}\includegraphics[width=0.15\textwidth]{Fig-19c.jpg}}
	\subfloat [Olympus waterproof camera]{\label{fig:20d}\includegraphics[width=0.25\textwidth]{Fig-19d.jpg}}
...
\begin{longtable}{|r|r|r|r|r|r|r|}
	\caption{Results of the statistical analysis of spectral reflectance of \textbf{carbonate sand}, with average values (for sets 1-3). Wavelength step: 3 nm. Measured on Agia Pelagia beach, 14th October}\label{tab:31} \\
 		 \multicolumn{1}{|l|}{\textbf{wl}} &
  		 \multicolumn{1}{l|}{\textbf{min}} & 
  		 \multicolumn{1}{l|}{\textbf{Q1}} & 
  		 \multicolumn{1}{l|}{\textbf{mean}} & 
