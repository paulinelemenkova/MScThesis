...
%\usepackage{index}
\usepackage{imakeidx}
\makeindex[name=concepts,title=Index of Concepts,intoc]
\makeindex[name=people,title=Index of People,intoc,columns=3,columnseprule]
...
\restylefloat{figure}
\usepackage{hyperref}
\hypersetup{pdftitle={Seagrass mapping and monitoring along the coasts of Crete, Greece}, pdfauthor={Lemenkova Polina}, pdfsubject={MScThesis}, pdfcreator={Lemenkova Polina}, pdfproducer={Lemenkova Polina}, colorlinks=true,linkcolor=Navy, citecolor=Crimson, filecolor=magenta, urlcolor=blue,pdfkeywords={P.oceanica, seagrass, spectral reflectance, remote sensing, WASI, RTM, Google Earth, mapping, Crete}}
%\hypersetup{pdftitle={Seagrass mapping and monitoring along the coasts of Crete, Greece}, pdfauthor={Lemenkova Polina}, pdfsubject={MScThesis}, pdfcreator={Lemenkova Polina}, pdfproducer={Lemenkova Polina}, colorlinks=true,linkcolor=black, citecolor=black, filecolor=black, urlcolor=black,pdfkeywords={P.oceanica, seagrass, spectral reflectance, remote sensing, WASI, RTM, Google Earth, mapping, Crete}}
...
%\newcommand{\listpeoplename}{}
%\newlistof{people}{peo}{\listpeoplename}
%\newcommand{\people}[1]{\refstepcounter{people}}

%\newindex[List of People]{person}
...
\begin{titlepage}
	...
	%\affil[1]{MSc student at the \textit{University of Twente, Faculty of Geo-Information Science and Earth Observation (ITC)}, The Netherlands}
	\date{March 2011}
	\maketitle	
\end{titlepage}
\pagebreak
...
\begin{figure}[H]
	\centering
	\subfloat{\includegraphics [width=0.2\textwidth] {Logo-Sou.jpg}}
	\hspace{3mm}
	\subfloat{\includegraphics [width=0.1\textwidth] {Logo-Lun.jpg}}
	\hspace{3mm}
	\subfloat{\includegraphics [width=0.1\textwidth] {Logo-War.jpg}}
	\hspace{3mm}
	\subfloat{\includegraphics [width=0.5\textwidth] {ITC-logo.jpg}}	
\end{figure}
...
\vspace{1em}
by Lemenkova Polina\index[people]{Lemenkova, P.}
\end{center}
...
\begin{itemize}
	\item Chair: Prof. Dr. \textit{Andrew K. Skidmore}\index[people]{Skidmore A.K.}
	\item External Examiner: Dr. {\textit{Ma\l{}gorzata Roge-Wi\'sniewska}\index[people]{Roge-Wi\'sniewska, M.}}
	\item Internal Examiner: Ms. Ir. \textit{Louise M. van Leeuwen}\index[people]{Leeuwen, L. M. van}
\end{itemize}
...
\begin{itemize}
	\item[* ] First supervisor: Mr. \textit{Valentijn Venus}\index[people]{Venus, V.} 
	\item[* ] Second supervisor: Dr. \textit{Albertus G. Toxopeus}\index[people]{Toxopeus, A.G.}  
\end{itemize}
...
\begin{dedication}
\large{\textsc{To my elder brother and best friend, \textbf{Peter Lemenkov}\index[people]{Lemenkov, P.}}}
\end{dedication}
%\end{flushright}
\pagebreak
...
\vspace{1mm}\\
I thank my scientific supervisors, Dr. \textit{Albertus G.Toxopeus}\index[people]{Toxopeus, A.G.}  and Mr. \textit{Valentijn Venus}\index[people]{Venus, V.} from the ITC, Department of Natural Resources, for our successful scientific collaboration, help and discussions of my research work. 
...
I extend my gratitude to the staff of the Museum of Natural History, Department of Zoology of the University of Crete, especially to Dr.\textit{Petros Lymberakis}\index[people]{Lymberakis, P.} and his colleagues, for their assistance during our fieldwork, providing us with all necessary equipment (e.g. SCUBA gear diving, instruments for underwater measurements, etc). I also appreciate their very warm, personal attitude and interest towards our research. 
\vspace{1mm}\\
My sincere gratitude goes again to Mr.\textit{Valentijn Venus}\index[people]{Venus, V.} for his generous providing me with a lot of spatial data   relevant to my research (e.g. such as digital vector layers of Crete island, raster georeferenced maps for the whole island for my GIS project, Excel spreadsheets, etc). Without these vital data the implementation of this project would have hardly been possible. I am also thankful to him for the technical help in Google Earth imagery capturing, using GDAL technologies and assistance during the fieldwork (videometric underwater footage, consultancies in seagrass observation and monitoring, driving boat, etc). \\ My special thank to his personal, friendly support in various situations on Crete.\vspace{1mm}\\
I am thankful to Dr.rer.nat.\textit{Peter Gege}\index[people]{Gege P.}, the software developer from the Earth Observation Centre of the German Space Agency, for his generous consultancies concerning the technical question about WASI that arose during my work. I am thankful for all his explanations and articles given to me via e-mail \vspace{1mm}\\
My special thanks are addressed to my elder brother, Mr.\textit{Peter Lemenkov}\index[people]{Lemenkov, P.}, the software developer from the ipPort, for his priceless numerous advices and constant professional support throughout my career. He encouraged me to use various very useful software and tools, always gave me necessary recommendations and precious help, thus highly contributing to my professional growth. \\ My special thank for his help with Python scripting. \\
I am also heartfelt thankful to him for his personal friendship and support. 
\vspace{1mm}\\
I am grateful to Mr.\textit{Willem Nieuwenhuis}\index[people]{Nieuwenhuis, W.}, the software developer from the ITC, Department of Natural Resources, for shared technology of Google Earth aerial imagery grabbing and for his consultancy with ASTER imagery. 
\vspace{1mm}\\
I thank Dr. Ir. \textit{Cornelis A.J.M. de Bie}\index[people]{de Bie C.A.J.M.} from the Department of Natural Resource, ITC, for his patient sharing of iPAQ knowledge during my Polish fieldwork in summer 2010. I used this skills on Crete. 
\vspace{1mm}\\
Many thanks for Dr. \textit{Dingtian Yang}\index[people]{Yang D.} from the South China Sea Institute of Oceanology, our colleague in problem of seagrass monitoring and research, for his handing over the data of spectral reflectance of Thalassia seagrass, which enabled to compare spectra of various seagrass types. 
...
\section*{Abstract}
	\markright{Summary Abstract of the MSc Thesis}
...
A lot of plotted graphs, statistical outcomes, tables, auxiliary (yet relevant to our research) pictures and images, illustrating our work - are collected in the \nameref{app}. Due to the standard editorial limitations of the current MSc work, it was not possible to include all them to the main chapters. However, we tried to make the structure of the Appendices most clear and easy-readable as possible, by dividing the Appendices into 10 various sub-sections and referencing to them from the main text where necessary. \\
The \nameref{bib} section includes literature and internet resources used for the current work. The cross-referencing and web hyper-referencing are used in the whole document to make reading more quick, effective and informative.\\
...
%\singlespacing
\begin{acronym}
	\acro{4AOP}{\href{http://www.noveltis.fr/4AOP/interface/index.php}{Automatized Atmospheric Absorption Atlas Operational Release}} 
	\acro{6SV1}{\href{http://6s.ltdri.org/}{Second Simulation of a Satellite Signal in the Solar Spectrum Version1}} 
	\acro{ASCII}{\href{http://en.wikipedia.org/wiki/ASCII}{American Standard Code for Information Interchange}}
	\acro{ANOVA}{\href{http://en.wikipedia.org/wiki/Anova}{ANalysis of VAriance}} 
	\acro{ASTER}{\href{http://asterweb.jpl.nasa.gov/}{Advanced Spaceborne Thermal Emission and Reflection Radiometer}} 
	\acro{BRDF}{Bidirectional Reflectance Distribution Function}
	\acro{CASI}{\href{http://www.borstad.com/casi.html}{Compact Airborne Spectrographic Imager}}
	\acro{CDOM}{\href{http://en.wikipedia.org/wiki/CDOM}{Colored Dissolved Organic Matter}}
	\acro{CNES}{\href{http://www.cnes.fr/}{Centre National d'Etudes Spatiales (of France)}}
	\acro{CRTM}{\href{http://www.jcsda.noaa.gov/projects_crtm.php}{Community Radiative Transfer Model}}
	\acro{CZCS}{\href{http://oceancolor.gsfc.nasa.gov/CZCS/}{Coastal Zone Color Scanner}}
	\acro{DISORT}{\href{ftp://climate1.gsfc.nasa.gov/wiscombe/Multiple_Scatt/DISORT1.2/}{Discrete Ordinates Radiative Transfer Program for a Multi-Layered Plane-Parallel Medium}}
	\acro{ENVISAT}{\href{http://envisat.esa.int/instruments/meris/}{ENVIronmental SATellite}}
	\acro{ESA}{\href{http://www.esa.int/}{European Space Agency}}
	\acro{FOV}{\href{http://en.wikipedia.org/wiki/FOV}{Field Of View}}
	%\acro{ERS}{European Remote Sensing satellite}
	\acro{GDAL}{\href{http://www.gdal.org/}{Geospatial Data Abstraction Library}}
	\acro{GIS}{Geographic Information System}
	%\acro{GNU}{GNU's Not Unix}
	\acro{GloVis}{\href{http://glovis.usgs.gov/}{Global Visualization Viewer}}
	\acro{GPS}{\href{http://en.wikipedia.org/wiki/GPS}{Global Positioning System}}
	\acro{GRASS}{\href{http://grass.fbk.eu/}{Geographic Resources Analysis Support System}}
	\acro{GRETL}{\href{http://gretl.sourceforge.net/}{GNU Regression, Econometrics and Time-series Library}}
	\acro{HCMR}{\href{http://www.hcmr.gr/}{Hellenic Centre for Marine Research }}
	\acro{GUI}{\href{http://en.wikipedia.org/wiki/Graphical_user_interface}{Graphical User Interface}}
	\acro{HyMap}{\href{http://www.hyvista.com/}{Hyperspectral Mapper}}
	\acro{HyperOCR}{\href{http://www.satlantic.com/Hyperspectral_Radiometers/Hyperspectral_Radiometers.asp}{Hyperspectral Ocean Colour Radiometer}}
	\acro{ILWIS}{\href{http://www.ilwis.org/}{Integrated Land and Water Information System}}
	\acro{iPAQ}{\href{http://welcome.hp.com/country/us/en/prodserv/handheld.html}{Internet Pocket PC by CompAQ}}
	\acro{KOPRA}{\href{http://www.imk-asf.kit.edu/english/312.php}{Karlsruhe Optimized and Precise Radiative transfer Algorithm}}
	\acro{LAD}{\href{http://en.wikipedia.org/wiki/Least_absolute_deviations}{Least Absolute Deviations}}
	\acro{LAI}{\href{http://en.wikipedia.org/wiki/Leaf_Area_Index}{Leaf Area Index}}
	\acro{Landsat TM}{\href{http://landsat.gsfc.nasa.gov/}{Landsat Thematic Mapper}}
	\acro{Landsat ETM+}{\href{http://landsat.gsfc.nasa.gov/}{Landsat Enhanced Thematic Mapper Plus}}
	\acro{MERIS}{\href{http://envisat.esa.int/instruments/meris/}{MEdium Resolution Imaging Spectrometer}}
	\acro{MIPAS}{\href{http://envisat.esa.int/instruments/mipas/}{Michelson Interferometer for Passive Atmospheric Sounding}}
	\acro{MODIS}{\href{http://modis.gsfc.nasa.gov/}{MODerate resolution Imaging Spectroradiometer}}
	\acro{NASA}{\href{http://www.nasa.gov/}{National Aeronautics and Space Administration}}
	\acro{NIR}{Near-Infra-Red}
	\acro{NOAA}{\href{http://www.osdpd.noaa.gov/ml/index.html}{National Oceanic and Atmospheric Administration}}
	\acro{OBC}{On Board Calibration}
	\acro{OLS}{\href{http://en.wikipedia.org/wiki/Ordinary_least_squares}{Ordinary Least Squares}}
	\acro{Olympus ST}{\href{http://www.olympusamerica.com/}{Olympus Stylus Tough}}
	\acro{RRTM}{\href{http://rtweb.aer.com/}{Rapid Radiative Transfer Model}}
	\acro{RTTOV-9}{\href{http://research.metoffice.gov.uk/research/interproj/nwpsaf/rtm/}{Radiative Transfer for TIROS (Television and InfraRed Observation Satellite) Operational Vertical Sounder}}
	\acro{RTM}{Radiative Transfer Model}
	\acro{SAM}{Scanning Acoustic Microscope}
	\acro{SCUBA}{\href{http://www.padi.com/scuba/}{Self Contained Underwater Breathing Apparatus}}
	\acro{SeaWiFS}{\href{http://oceancolor.gsfc.nasa.gov/SeaWiFS/}{Sea-viewing Wide Field-of-view Sensor}}
	\acro{SPOT}{\href{http://www.spotimage.fr/}{Satellite Pour l'Observation de la Terre}}
	\acro{SPSS}{ \href{http://www.spss.com/}{Statistical Package for the Social Sciences}}
	\acro{STDEV}{Standard Deviation}
	\acro{SWIR}{Short Wave InfraRed}
	\acro{TIR}{Thermal InfraRed}
	\acro{Trios-RAMSES}{\href{http://trios.de/index.php?option=com_content&view=category&layout=trios&id=47&Itemid=76&lang=en}{RAdiance Measurement SEnSor}}
	\acro{UML}{\href{http://en.wikipedia.org/wiki/Unified_Modeling_Language}{Unified Modelling Language}}
	\acro{USGS}{\href{http://www.usgs.gov/}{U.S. Geological Survey}}
	\acro{UV}{UltraViolet (10 nm to 400 nm)}
	\acro{UVA}{UltraViolet A, or long waves (315 nm-400 nm)}
	\acro{UVB}{UltraViolet B, or medium waves (280 nm-315 nm)}
	\acro{VIS}{VISible}
	\acro{VNIR}{Visible and Near-InfraRed}
	\acro{WASI}{\href{http://www.filewatcher.com/b/ftp/ftp.dfd.dlr.de/pub/WASI.0.0.html}{WASI Water Color Simulator}}
	\acro{WLS}{\href{http://en.wikipedia.org/wiki/Weighted_least_squares}{Weighted Least Squares}}
\end{acronym}
\pagebreak
...
\section*{List of Tools}\label{sec:0}
	...
	\addcontentsline{toc}{section}{List of Tools}\index[concepts]{Software used}
...
\cite{McKenzie08}\label{McKenzie08}. Seagrasses\index[concepts]{Seagrasses} create unique, complex, extremely diversified and productive ecological systems in the
...
Globally, there are 58 recognized and described seagrass species\index[concepts]{Seagrasses!global species} (Fig.\ref{fig:2}, Fig.\ref{Fig.4})\label{page-2}, belonging to two orders
...
include climate (mostly, tropical and temperate areas, Fig.\ref{Fig.4}\index[concepts]{Seagrasses!distribution of}), bathymetry (shallow shelf zones), hydrological
...
There are four European seagrass species \index[concepts]{Seagrasses!Mediterranean species} in Mediterranean area \cite{Borum04}\label{Borum04}: \textit{Zostera marina,
...
Being often confused with marine ``\textit{algae}"\index[concepts]{Algae}, ``\textit{seagrasses}" are vastly different from them.
...
Meadows of \textit{P. oceanica} (Fig.\ref{fig:1})\label{page-3} are subjected to the human activities\index[concepts]{Seagrasses!ecological vulnerability}, as they occur in coastal areas, where
...
e.g. thermal, sewage, dredging and chemical pollution\index[concepts]{Seagrasses!anthropogenic impacts on}  as well as any other kind of maritime works,
...
Besides anthropogenic factors, various biochemical, climatic and environmental processes\index[concepts]{Seagrasses!natural impacts on} can cause
...
\subsubsection{General characteristics of \textit{P.oceanica}}\index[concepts]{Seagrasses!\textit{P.oceanica}}
...
spatially restricted to the Mediterranean area\index[concepts]{Seagrasses!\textit{P.oceanica}!distribution} (Fig.\ref{fig:5}), 
...
Morphologically\index[concepts]{Seagrasses!\textit{P.oceanica}!morphology}, \textit{P.oceanica} consists of long, 5-12 mm broad, “hairy-like” leaves, 3-4 mm thick roots and short rhizomes (0.5-2.0 mm), Fig.\ref{fig:8}, Fig.\ref{fig:3}.\label{page-5}
...
\begin{figure}[H]
	\centering
	\subfloat [\textit{P.oceanica}. Source \cite{Luque04}\label{Luque04}]{\includegraphics[width=0.25\textwidth]{Fig-1-6.jpg}}
	\subfloat [Scheme of matte structure of \textit{P.oceanica}. Source\cite{Pergent90}\label{Pergent90}]{\includegraphics[width=0.3\textwidth]{Fig-1-7.jpg}}
	\subfloat [Structure and components of \textit{P.oceanica}. Source\cite{DiCarlo04}\label{DiCarlo04}]{\includegraphics[width=0.3\textwidth]{Fig-1-8.jpg}}
...
The adaptation\index[concepts]{Seagrasses!\textit{P.oceanica}!environmental adaptation}
...
The phenology\index[concepts]{Seagrasses!\textit{P.oceanica}!phenology} of \textit{P.oceanica} is also affected by the coastal bathymetry: in the isolated meadows in shallow waters plants have shorter and falciform leaves, compared to ones in the deeper and central
...
\subsection{Research problem}\index[concepts]{Research}
Monitoring\index[concepts]{Research!problem} of the marine benthic ecosystems of seagrasses is essential for the environmental
...
\subsection{Research objective}\index[concepts]{Research!objective}
...
from the following sources \index[concepts]{Data}:
	\begin{itemize}
...
\subsubsection{General objective}\index[concepts]{Research!objective!general}
...
\subsubsection{Specific objectives}\index[concepts]{Research!objective!specific}
	\begin{itemize}	
...
\subsection{Research questions}\index[concepts]{Research!questions}
	\begin{itemize}	
...
\subsection{Hypotheses}\index[concepts]{Research!questions!hypothesis}
...
\subsection{Assumptions}\index[concepts]{Research!assumptions}
...
We also assume that concentration of non-chlorophyll particles (absorption at $\lambda_0$) as well as concentration of small suspended particles is equal to zero, so we do not count them in this work. Exponent of \ac{CDOM} (Gelbstoff) absorption is accepted as 0.0140. Finally, the \ac{BRDF} of bottom reflectance (sand), which defines reflection of light  is at an opaque surface (Fig.\ref{fig:BRDF})\label{page-11}, is assumed to be 0.318 $sr^{-1}$.

\subsection{Research approach}\index[concepts]{Research!approach}
...
\markright{Seagrass monitoring: overview of literature and research resources}
\renewcommand{\headrulewidth}{0.4pt}
\counterwithin{figure}{section}
\counterwithin{table}{section}

\subsection{Seagrass global monitoring: history and perspectives}\index[concepts]{Seagrasses!global monitoring}
...
Various global seagrass survey organizations \index[concepts]{Seagrasses!global surveys} organize and provide regular monitoring of the seagrass species distribution, health and environmental sustainability. \\ We list below the most important and world-known scientific institutions focusing on seagrass research: 
\begin{itemize}
...
\sectionmark{Measuring optical properties}}
\sectionmark{Overview of literature...}\label{sec:2-2}\label{page-12}
...
\begin{figure}[H]
	\centering
	\subfloat [\ac{Trios-RAMSES}-ACC-UV - Hyperspectral UVA/UVB Irradiance Sensor: 280-500 nm]{\label{fig:1-1a}\includegraphics[width=0.4\textwidth]{Fig-2-1.jpg}}
	\subfloat [\ac{Trios-RAMSES}-ARC - Hyperspectral UV-VIS Radiance Sensor: 320-950 nm.]{\label{fig:1-1b}\includegraphics[width=0.4\textwidth]{Fig-2-2.jpg}}
...
The optical properties\index[concepts]{Seawater optical properties} of the sea water vary with different environmental conditions and reflect
...
remote sensing\index[concepts]{Seawater optical properties!hyperspectral measurements} and reinforce other processes \cite{Maffione01b}\label{Maffione01b}. Thus, waves and tides increase
...
The irradiance\index[concepts]{Seawater optical properties!irradiance} and radiance\index[concepts]{Seawater optical properties!radiance} of the water thus should be measured, in order to estimate spectral
...
optical sensors spectroradiometers\index[concepts]{Seawater optical properties!spectroradiometers}. There are several companies producing radiometers with various
...
\href{http://www.spectrapartners.nl/}{SpectraPartners}, etc. \ac{Trios-RAMSES}\index[concepts]{Seawater optical properties!spectroradiometers!Trios-RAMSES} hyperspectral radiometers
...
%\subsection[Radiative Transfer Models (RTM)]{Radiative Transfer Models (RTM) for the simulation of water optical properties: a brief review of existing software tools}\label{sec:2-3}
...
We briefly discuss below the most effective RTM software and algorithms, suitable for underwater radiance simulations, from a range of various best-known up-to-date tools. 
	\begin{itemize}
		\item [*] The \ac{6SV1} \index[concepts]{Seawater optical properties!RTM!6SV1} is a US atmospheric correction algorithm, developed in the University of Maryland; adjusted for the \ac{MODIS} satellite imagery lookup tables. The 6S algorithm has been \href{http://grass.osgeo.org/grass64/manuals/html64_user/i.atcorr.html}{implemented} by the \ac{GRASS} software for the atmospheric correction 	 
		\item [*] Another example of the RTM adjusted for a specific imagery is a German \ac{KOPRA}\index[concepts]{Seawater optical properties!RTM!KOPRA}, fitted for \ac{MIPAS} and \ac{ENVISAT} imagery.
		...
		\item [*] The British \ac{RTTOV-9}\index[concepts]{Seawater optical properties!RTM!RTTOV-9} is a radiative transfer model, developed for nadir viewing atmospheric sounders and imagers. It includes a number of useful tolls, e.g. can compute sea-surface emissivity for each channel, enables, to specify cloudiness for radiance calculations, etc.  This program runs under Unix/Linux platforms and is open source. 
		\item [*] The \ac{RRTM}\index[concepts]{Seawater optical properties!RTM!RRTM} is one more RTM freeware, designed in the USA, Massachusetts. 
		\item [*] The \href{http://www.modtran.org/}{\textit{MODTRAN}}\index[concepts]{Seawater optical properties!RTM!MODTRAN}, a commercial software from Spectral Sciences Inc., is another example of the RTM. Among its newest updates is generation of atmospheric correction data; it also has an option to write spectral output in binary, and convert it to \ac{ASCII}.
		\item [*] The \ac{CRTM} \index[concepts]{Seawater optical properties!RTM!CRTM} is designed by the  (\href{http://www.jcsda.noaa.gov/}{JCSDA}, \ac{NASA}) and includes Surface Emissivity/Reflectivity Models, Cloud Absorption/Scattering Model and Gaseous Absorption Model.
	\end{itemize}
For our purpose we have chosen the \ac{WASI}\index[concepts]{Seawater optical properties!RTM!WASI} \ac{RTM} software, due to its effectiveness, adaptability for the Mediterranean environment, open source availability, coverage of necessary wavebands and clear, user friendly interface, enabling to adjust various environmental parameters.
...
quadrant frame, single point markers, \ac{GPS}, laptops with installed software (\ac{GIS}), \ac{SCUBA} equipment, \ac{iPAQ} and other auxiliary tools\label{page-15} (Fig.\ref{fig:3.3}). The seagrass sampling is taken on the regular way with observation points covering the study area with normal distribution (Fig.\ref{fig:A.20}, Fig.\ref{fig:A.19}\label{page-norm}).
...
\subsection[Application of the remote sensing data towards seagrass mapping]{Application of the remote sensing data towards seagrass mapping}\index[concepts]{Remote sensing}\label{page-15}
...
The underwater videography\index[concepts]{Remote sensing!underwater videography} with a \ac{GPS}\index[concepts]{Remote sensing!GPS} is a tool of seagrass monitoring which has certain advantages, i.e.
...
Spectral measurements\index[concepts]{Remote sensing!spectral measurements} of the target objects are made
...
Studies of spectral reflectance\index[concepts]{Seawater optical properties!spectral reflectance} of the different seagrass species comparing to the spectra of sand and other seafloor cover types \cite{Vahtmae06}\label{Vahtmae06} prove that spectra of green, brown and red benthic
...
leaf area index (\ac{LAI}) of the seagrass. The spectral reflectance in general is the
result of the spectral absorption in different bands, typical for each target object.
Spectral reflectance\index[concepts]{Seawater optical properties!spectral reflectance} of the seagrass  (Fig.\ref{fig:13})\label{page-17} is largely influenced by the water depth where it is located, and is generally decreasing in values by increasing depths.
The most important spectral diapason\index[concepts]{Seawater optical properties!spectral reflectance!spectral diapason} for marine mapping of submerged vegetation and, particularly, for seagrass, is 350-800 nm \cite{Barille09}\label{Barille09}.
...
(e.g., \href{http://landsat.gsfc.nasa.gov/}{Landsat MSS, Landsat TM, Landsat ETM+}, \href{http://envisat.esa.int/instruments/meris/}{MERIS} from \ac{ESA}, \href{http://asterweb.jpl.nasa.gov/}{ASTER}, \href{http://modis.gsfc.nasa.gov/}{MODIS}) and high resolution as
...
In the next paragraphs (\nameref{sec:2.4.1} and \nameref{sec:2.4.2}) we will briefly discuss research experience of the application of satellite imagery towards seagrass mapping, its advantages and limitations, reported by various researchers.

\subsubsection[Review of multispectral imagery used for seagrass mapping]{Review of multispectral imagery used for seagrass mapping}\subsectionmark{Review of multispectral imagery used for seagrass mapping}\label{sec:2.4.1}\index[concepts]{Remote sensing!multispectral imagery}
...
landscapes.
The \ac{Landsat TM}\index[concepts]{Remote sensing!multispectral imagery!Landsat TM} and \ac{Landsat ETM+}\index[concepts]{Remote sensing!multispectral imagery!Landsat ETM+} data, with the most recent from sensor Landsat 7 - an advanced
...
Another well-known multispectral sensor, \ac{SPOT}\index[concepts]{Remote sensing!multispectral imagery!SPOT} provides multispectral imagery with a spatial resolution of 10 m (Fig.\ref{fig:2.4}), covering covers a surface area of 3600 km² (60*60 km swath), 26-day
...
The \href{http://www.satimagingcorp.com/gallery-ikonos.html}{IKONOS}\index[concepts]{Remote sensing!multispectral imagery!IKONOS}, offering multispectral and panchromatic imagery, was the first to collect publicly
...
made using IKONOS, \ac{Landsat TM}, and \ac{CASI}\index[concepts]{Remote sensing!multispectral imagery!CASI}, show that in the blue part of the
...
landscapes. Thus, \ac{CASI} and Quickbird-2\index[concepts]{Remote sensing!multispectral imagery!Quickbird} images enable to identify even separate seagrass species
...
\ac{ASTER}\index[concepts]{Remote sensing!multispectral imagery!ASTER}), launched in
1999 on board Terra sensor\index[concepts]{Remote sensing!multispectral imagery!Terra sensor}, provides high-resolution images of the Earth in 15 different bands of the
...
\subsubsection[Review of hyperspectral imagery used for seagrass mapping]{Review of hyperspectral imagery used for seagrass mapping}\subsectionmark{Review of hyperspectral imagery used for seagrass mapping}\label{sec:2.4.2}\index[concepts]{Remote sensing!hyperspectral imagery}
...
overall accuracies \cite{Phinn08}\label{Phinn08}. Several, regular and narrow (10 nm) spectral bands\label{sec:2.4.2}\index[concepts]{Remote sensing!hyperspectral imagery!spectral bands}, specific for
...
Comparative analysis of the application of hyperspectral\label{sec:2.4.2}\index[concepts]{Remote sensing!hyperspectral imagery!application} and multispectral imagery towards the
...
\subsubsection[Comparison of seagrass spectra]{Comparison of seagrass spectra}\subsectionmark{Comparison of seagrass spectra}\label{sec:2.5.3}
...
\subsection{Fieldwork data collection}\index[concepts]{Data!collection}
...
\begin{figure}[H]
	\centering
	\subfloat [iPAQ, HP]{\label{fig:3.3a}\includegraphics[width=0.2\textwidth]{Fig-19a.jpg}}
	\subfloat [Waterproof Otterbox for iPAQ]{\label{fig:3.3b}\includegraphics[width=0.2\textwidth]{Fig-19b.jpg}}
	\subfloat [GPS]{\label{fig:3.3c}\includegraphics[width=0.15\textwidth]{Fig-19c.jpg}}
	\subfloat [Olympus waterproof camera]{\label{fig:3.3d}\includegraphics[width=0.2\textwidth]{Fig-19d.jpg}}
...
without location bias (Fig.\ref{fig:A.7})\label{page-A12}. 

\begin{figure}[H]
	\centering
	\subfloat [view from below]{\label{fig:22a}\includegraphics[width=0.3\textwidth]{Fig-20a.jpg}}
	\subfloat [view \textit{en-face}]{\label{fig:22a}\includegraphics[width=0.3\textwidth]{Fig-20b.jpg}}
	\subfloat [view from above]{\label{fig:22a}\includegraphics[width=0.3\textwidth]{Fig-20c.jpg}}
...
the fieldwork using cord, \ac{iPAQ}, and markers (Fig.\ref{fig:A.55})\label{page-A55} in order to assure that the videometric measurements
...
\end{itemize}
The available satellite imagery (Fig.\ref{fig:A.38}, Tab.\ref{tab:34}) \label{page-30}and aerial images are read into the ArcGIS project.
The available broadband and hyperspectral remote sensing data are used for the mapping of the
seagrass in shelf areas no deeper than 4.0 meters (Fig.\ref{fig:A.39}, Fig.\ref{fig:A.40}, Fig.\ref{fig:A.41}, Fig.\ref{fig:A.42})\label{page-A45-47}, for the environmental monitoring in order to detect spatial distribution of the seagrass along Crete during the past ten years using
different satellite images for 2000-2010 (Fig.\ref{fig:24})\label{page-fig37}.

\begin{figure}[h]
	\centering
	\includegraphics[scale=0.40]{UML_Dia.jpg}
	\caption{Work flow for the data acquisition, \href{http://live.gnome.org/Dia}{Dia} display. Page: $<$\pageref{page-fig37}$>$}
	\label{fig:24}
\end{figure}
...
\ac{UVA}/\ac{UVB} Irradiance Sensor and \ac{Trios-RAMSES}-ARC Hyperspectral \ac{UV}-\ac{VIS} Radiance Sensor (Fig. \ref{fig:2.1}), both adjusted for the measurements of the irradiance and radiance (see \nameref{app}: Tab. \ref{tab:A.1}, Tab. \ref{tab:A.2}). 
...
\subsection{Data pre-processing}\index[concepts]{Data!pre-processing}
...
calculation of the median, mean, quartiles and other statistical values at every data set (see \nameref{app},\label{dataprep} Fig. \ref{fig:A.25}, Tab. \ref{tab:17}).
...
comparing to splines (see \nameref{app} for more results). 
...
The adjusted averages evaluate mean values of trend, needed for statistical analysis of the datasets (Fig.\ref{fig:A.32}). 
The outcome of this calculations is shown in the Tab.\ref{tab:5} and Tab.\ref{tab:6} (\nameref{app}). \\
As a result, we received mean values of spectral reflectance of \textit{P.oceanica} for extreme, average (Fig.\ref{fig:A.34}, Fig.\ref{fig:A.33})\label{page-ave}, median and both quartiles, independent of the individual sets 1-350. \\
We used several statistical methods (Fig.\ref{fig:4.12})\label{stan} to asses data received as a result of measurements. 
The Student-t test\index[concepts]{Data!statistical analysis!Student-t testing},
...
of data points. Therefore, we used the data (\nameref{app}) of means of spectral reflectance of the both
...
\subsection{Spectral simulation of aquatic objects}\index[concepts]{Data!processing}\label{page-35}
...
types, where the spectral signatures were examined. \ac{WASI} software\index[concepts]{Seawater optical properties!RTM!WASI} (Fig.\ref{fig:4.7}) is used to simulate spectral reflectance and colour discrimination of water, affected by presence of \textit{P.oceanica} and other factors, under various
...
Seagrass beds are clearly visible in color aerial Google Earth\index[concepts]{Remote sensing!aerial imagery!GoogleEarth}
...
\begin{figure}[H]
	\centering
	\subfloat [small-scaled (1:54,000)]{\label{fig:38a}\includegraphics[width=0.45\textwidth]{Fig35a.jpg}}
	\hspace{1ex}
	\subfloat [enlarged (1:10,000)]{\label{fig:38b}\includegraphics[width=0.45\textwidth]{Fig35b.jpg}}
...
\begin{figure}[H]
	...
	\caption{Combined plots of simulated remote sensing reflectance of \textit{P.oceanica} at various sensors: \ac{MODIS}, \ac{MERIS}, \ac{SeaWiFS} and \ac{CZCS}, iterated over three depths, as stripes shown spectral bands covered by these sensors. Pages: $<$\pageref{page-21}$>$, $<$\pageref{page-22}$>$, $<$\pageref{page-33}$>$, $<$\pageref{secondq}$>$}
	\label{fig:4.6}
\end{figure}
...
\begin{figure}[H]
	\centering
	\subfloat [depth of 0.5 m]{\label{fig:32a}\includegraphics[width=0.4\textwidth]{Fig-32a-SB.jpg}}
	\subfloat [depth of 2.0 m]{\label{fig:32b}\includegraphics[width=0.4\textwidth]{Fig-32b-SB.jpg}}\\
	\subfloat [depth of 3.5 m]{\label{fig:32c}\includegraphics[width=0.4\textwidth]{Fig-32c-SB.jpg}}
	\subfloat [depths of 0.5, 2.0 and 3.5 m]{\label{fig:32d}\includegraphics[width=0.4\textwidth]{Fig-32d-SB.jpg}}
	\caption{Simulated remote sensing reflectance of \textit{P.oceanica} at various depths. Pages: $<$\pageref{page-37}$>$, $<$\pageref{page-32}$>$.\\ Vertical stripes show coverage of spectral bands by MERIS sensor}
	\label{fig:4.9}
\end{figure}

An analysis of the spectral reflectance of \textit{P.oceanica} is done using the \ac{WASI} simulations\index[concepts]{Seawater optical properties!RTM!WASI} in order to determine, which wavebands can be still used to identify \textit{P.oceanica}. The analysis of spectra shows
...
\begin{figure}[H]
	\centering
	\subfloat [Sand]{\label{fig:34a}\includegraphics[width=0.3\textwidth]{Fig-27a.jpg}}
	\subfloat [\textit{P.oceanica}]{\label{fig:34b}\includegraphics[width=0.3\textwidth]{Fig-27b.jpg}}
...
\subsubsection{Statistical analysis of the observational data and hypothesis testing}\index[concepts]{Data!statistical analysis}
...
The statistical calculators were mainly made by means of \ac{GRETL}\index[concepts]{Data!statistical analysis!Gretl} and SPSS\index[concepts]{Data!statistical analysis!SPSS}. 
The Open Office was used for preliminary data view and preprocessing, and included following computations
at each data set (for example, Fig.\ref{fig:A.11}) with summary outcome of mean, median, Q1 and Q3, standard deviation, min and max values (Tab.\ref{tab:4}, Tab.\ref{tab:A.8}).\label{page-sumstat} 
...
In the statistical analysis of the raw observed data pool\index[concepts]{Data!measurements pool} of the values of spectral reflectance (about 400 single measurements for \textit{P.oceanica}, e.g. Tab.\ref{tab:A.8}), we summarize their complexity by concentrating on some simple numerical characteristics that they possess, i.e. parameters. Examples are the mean and variance of a probability distribution of measurements dataset (for example, Tab.\ref{tab:4.1}). We divided the total data pool into datasets of 25 measurements for more convenience and ease of use, both for \textit{P.oceanica} and carbonate sand. The mean of a probability distribution of spectral reflectance describes the average value of the random variable over all of its possible realizations (\nameref{app}). Conceptually, there are an infinite number of such realizations, therefore parameters are not known to us. However, in the statistical analysis of the observed data our goal is to estimate these parameters using a finite amount of information available to us: fieldwork observations.
...
Each time we observe the outcome of a random variable\index[concepts]{Data!statistical analysis!variables} of spectral reflectance, we obtain an observation, which is hence no longer random. 
\label{statistics-1}
We applied various methods of statistical analysis towards data pool (some examples of the selected tables are in the \nameref{app}\label{page-41}: Tab.\ref{tab:18}, Tab.\ref{tab:24}, Tab.\ref{tab:25}, Tab.\ref{tab:26}, Tab.\ref{tab:29}), in order to analyze the distribution of values of spectral reflectance of \textit{P.oceanica}. 
A probability distribution\index[concepts]{Data!statistical analysis!probability distribution}, a mathematical statement about the possible values that the random observations of spectral reflectance can take on, displays the relative frequency with which each possible value of spectral reflectance is observed. 
The \ac{LAD}\index[concepts]{Data!statistical analysis!LAD}, a popular optimization technique, was used to show the main trend of the distribution of spectral reflectance values along the spectra (Tab.\ref{tab:12})\label{page-tab12}. Non-linear logistic analysis\index[concepts]{Data!statistical analysis!non-linear logistic analysis} is applied to specify and estimate a model of spectral distribution, in which the dependent variable (i.e. the value of spectral reflectance for each single observation) is not continuous, but discrete and independent for each case (Tab.\ref{tab:11}). \\
As the observations were made in a repeated way, we also analyzed the data pool using autocorrelation as well: Tab.\ref{tab:13} and Tab.\ref{tab:14} for \textit{P.oceanica} and Tab.\ref{tab:28} for carbonate sand. The \textit{autocorrelation}\index[concepts]{Data!statistical analysis!autocorrelation}, a cross-correlation\index[concepts]{Data!statistical analysis!cross-correlation} of an observed value with itself, made on two different days (14th and 15th October), shows the similarity between observations as a function of the time separation between them, 
as can be seen on Fig.\ref{fig:A.21}\label{A-23}, Fig.\ref{fig:A.22}\label{A-24} and Fig.\ref{fig:A.29}, it is a useful tool for finding repeating patterns for a single value of observations, such as the presence of a periodic signal which has been buried under noise. The autocorrelation analysis has been performed using both \ac{SPSS} and \ac{GRETL} software (Fig.\ref{tab:28}\label{page-a-c}). 
The method of \textit{least squares}\index[concepts]{Data!statistical analysis!least squares, method of} minimizes the sum of the squares of the errors made in solving every single observation made. We tried different approaches of the \textit{least squares} methods: Tab.\ref{tab:15}, Tab.\ref{tab:18}, \ac{WLS}: Tab.\ref{tab:27}\label{page-WLS}, \ac{OLS}: Fig.\ref{tab:15}\label{page-OLS}\\
To focus on the relationship between a dependent variable (each single observation of the spectral reflectance) and independent variables (three various depths: 0.5, 1.5 and 2.5 meters) we used the \textit{regression analysis}, which enables modeling and analyzing values of the spectral reflectance at several depths: Tab.\ref{tab:5}\label{page-reg}, Tab.\ref{tab:6}, Tab.\ref{tab:7}. 
The summary of the values of spectral reflectance properties on various depths is presented on the Tab.\ref{tab:A.7}.
The \textit{k-means cluster analysis}\index[concepts]{Data!statistical analysis!k-means cluster analysis} has been used for partitioning observation sets into k clusters (Tab.\ref{tab:20}, Tab.\ref{tab:21}, Tab.\ref{tab:22}, Tab.\ref{tab:23})\label{page-fincc} in which each observation belongs to the cluster with the nearest mean.
It enables to highlight the main areas of the location of values of spectral reflectance along the spectra.\\
To estimate spectral density of optical measurements we used periodogram\index[concepts]{Data!statistical analysis!periodogram} function (Tab.\ref{tab:30})\label{page-period}, which corresponds to the general spectrum of the observations with representation of a variable quantity.  
Thus, the periodogram (Fig.\ref{fig:A.31})\label{page-A31} of the series of observation\index[concepts]{Data!statistical analysis!observations, series of} highlights so-called “dead spots” of low power between the frequencies we wish to exclude (can be seen clearly at the end of the graphs, e.g. Fig.\ref{fig:A.12}) and the frequencies we want to retain (the general profile that lies in the 450-850 nm, Fig.\ref{fig:A.14}, enlarged part of 500-660nm).\\
...
areas of quartiles\index[concepts]{Data!statistical analysis!quartiles Q1-Q3} (Q1 - Q3, Fig.\ref{fig:A.30}\label{page-A30}, and shaded Q-Q areas on graph, Fig. \ref{fig:4.10}, Fig.\ref{fig:4.14}), which cover most probable data distribution (spectral reflectance) for each spectral band. In x-axis displayed are the areas of 400-950 nm in spectra, where the measurements were done; the y-axis was adjusted for the better visualization of the
...
focus on the most necessary area of spectral values (Fig.\ref{fig:4.14}, Fig.\ref{fig:4.4} and \nameref{app}). The mean values are
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Multiplot of spectral reflectance of \textit{P.oceanica}. Series 1-100. Shown mid-spread of the statistical quartiles Q1 and Q3 (vertical dashes) and mean value within the range (red bold dots). \href{http://www.gnuplot.info/}{Gnuplot}­. Pages: $<$\pageref{page-21}$>$, $<$\pageref{page-41}$>$, $<$\pageref{secondq}$>$}
		\label{fig:4.13}
	\end{center}
\end{figure}

A statistical hypothesis\index[concepts]{Data!statistical analysis!hypothesis testing} test has been applied for the making decision and controlling the wealth of the observational data of the hyperspectral measurements of the water reflectance.
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Multiplot of spectral reflectance of \textit{P.oceanica}. Series 126-150. Shown mid-spread of the statistical quartiles Q1 and Q3 (vertical dashes) and mean value within the range (red bold dots). \href{http://www.gnuplot.info/}{Gnuplot} visualization. Pages: $<$\pageref{page-39}$>$­, $<$\pageref{secondq}$>$­}
		\label{fig:A.27}
	\end{center}
\end{figure}

\paragraph{ANOVA-testing}\index[concepts]{Data!statistical analysis!ANOVA}
...
of spectral reflectances of \textit{P.oceanica} and carbonate sand at different depths, and and proved spectral discernibility of seagrass \textit{P.oceanica} from carbonate sand (Fig.\ref{fig:4.7})\label{firstq}, i.e. true is the opposite statement: Hypothesis $H_a$=“the spectral discernibility of the seagrass \textit{P.oceanica} is distinctly changing, 
and seagrass can be spectrally discriminated from carbonate sand with varying \textit{in-situ} conditions,
 i.e. increasing depth, $H_o: \mu\neq\mu2\neq\mu3\neq ... \neq\mu n$.
...
distinctly changing and can be discriminated from from other seafloor cover types (carbonate sand) with varying \textit{in-situ} conditions, 
i.e. increasing depth, $H_o: \mu1\neq\mu2\neq\mu3\neq...\neq\mu n$, which positively answers first research question.
Statistical results are illustrated with Error bars made using Excel's vertical box and Whisker Charts (Box Plots).
The graphs were plotted on the basis of the following statistical data calculated from the sampling
measurements data: Tab.\ref{tab:A.8}, Tab.\ref{tab:A.29}, Tab\ref{tab:4.1}.\label{last}
...
The abbreviations stand for the following values:
Mean: Average of the data to be plotted, AVERAGE\index[concepts]{Data!statistical analysis!average} {data}
St Dev: Standard deviation\index[concepts]{Data!statistical analysis!standard deviation}, \ac{STDEV} {data}
...
50th Pct: Plotting value of median = Median\index[concepts]{Data!statistical analysis!median}-Q1
...
types as the different sensors would percept them: \ac{MODIS}\index[concepts]{Remote sensing!multispectral imagery!MODIS}, \ac{ASTER}\index[concepts]{Remote sensing!multispectral imagery!ASTER}, \ac{MERIS}\index[concepts]{Remote sensing!multispectral imagery!MERIS}, \ac{SeaWiFS}\index[concepts]{Remote sensing!multispectral imagery!SeaWiFS} and \ac{CZCS}\index[concepts]{Remote sensing!multispectral imagery!CZCS}.\\
...
The analysis of the remote sensing reflectance simulated by these sensors shows that the measured spectra of seagrass \textit{P.oceanica} (Fig.\ref{fig:4.13}, Fig.\ref{fig:A.27}) were statistically different at most of the spectral bands (Fig.\ref{fig:A.25}, Fig.\ref{fig:A.26}), with a 95\% confidence level (p value $< 0. 05$).  The F values of the test (F=8.477 as on Tab.\ref{tab:6}) are greater than F critical value, which is 2.64 at 0.05 confidence level. This proves that broadband and hyperspectral sensors enable spectral discrimination of seagrass, i.e. $H_o: \mu1\neq\mu2\neq\mu3\neq ... \neq\mu n$. Therefore, we answer the second research question positively, i.e. broadband and hyperspectral sensors (Fig.\ref{fig:4.6} and Fig.\ref{fig:4.6W}) provide enough radiometric information for spectral discrimination of seagrass and can therefore be used for mapping of seagrass \textit{P.oceanica}.\label{secondq}

\subsection{GIS mapping of seagrass}

\index[concepts]{Data!integration}
...
\begin{figure}
	\begin{center}
		...
		\caption{Google aerial images incorporated into the GIS project: fragment of \href{http://www.esri.com/software/arcgis/index.html}{ArcGIS} layout. Page: $<$\pageref{fig4-17}$>$}
		\label{fig:4.17}
	\end{center}
\end{figure}
...
spectral signatures using \ac{WASI} software\index[concepts]{Seawater optical properties!RTM!WASI}, image processing by means of Erdas Imagine (Fig.\ref{fig:39}, Fig.\ref{fig:42}) and Arc \ac{GIS} based mapping. The use of \ac{GIS} for data incorporation (Fig.\ref{fig:4.17}), storage, analyses, visualizing and mapping enables to analyze environmental changes within seagrass landscapes based on data from various
...
integration of various data in one \ac{GIS}-project (Fig.\ref{fig:4.17})\label{fig4-17}. Data collected during the fieldwork, imagery
...
In \textit{Chapter 1:} \nameref{sec:1} we discusses main objective of this MSc thesis, which was to study possibilities of seagrass mapping, based on the application of the remote sensing measurement of the seawater optical properties using hyperspectral radiometers. 
...
The second \textit{Chapter 2:} \nameref{sec:2} starts from the review of the available research resources and then discusses various \nameref{sec:2-3} and concludes with reported experience of the remote sensing application towards seagrass mapping: \nameref{sec:2.4.1}. In section 2.2 of \textit{Chapter 2:} \nameref{sec:2}, \nameref{sec:2-2}, Measuring water optical properties: hyperspectral radiometers, the \ac{Trios-RAMSES}-ACC-\ac{UV} and \ac{Trios-RAMSES}-ARC spectroradiometers of \ac{Trios-RAMSES} Hyperspectral Sensor series are described. \\
...
\subsection{Upscale mapping of the seagrass landscapes}\index[concepts]{Seagrasses!spatial structure}\label{page-48}
...
patterns over different special scales (Fig.\ref{fig:41})\label{page-fig41}. The complexity of the landscape of seagrass meadow is shown by the
...
\begin{figure}[h]
	...
	\caption{Variations in spatial structure of the seagrass landscapes. Page: $<$\pageref{page-fig41}$>$}
	\label{fig:41}
\end{figure}
...
landscapes. Homogeneous, continuous seagrass meadows can reach in size up to $40 m^2$ (Fig.\ref{fig:38} a),
...
\subsection{Capturing aerial imagery from the Google Earth}
%\appendixname{\textbf{1: \\Capturing aerial imagery from the Google Earth: grabbing process}}
...
%%%%%%%%%%  \appendixname{Illustrations of some concepts and principles of the remote sensing}  %%%%%%%%%%%%%%
...
%\appendixname{\textbf{2:\\ Instrumental adjustment and tuning (Trios-RAMSES setup)}}
...
%\appendixname{\textbf{3: \\Types of seagrass structural patterns, Ligaria beach, Crete}}
...
%\appendixname{\textbf{5: \\Results of videographic measurements: seafloor types on Crete island}}
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Measurement underwater equipment.  Page: $<$\pageref{page-A12}$>$}\label{fig:A.7}		
	\end{center}
\end{figure}
\pagebreak

\subsection{Data pre-processing}
%\appendixname{\textbf{6: \\Data pre-processing}}
...
%\appendixname{\textbf{7:\\ Data processing and statistical evaluation: \\ Results of the measurements of the seafloor optical properties.}}
...
\begin{table}
	...
	\caption{Robust estimation of the seawater radiance (measured in aquarium tank, Heraklion): results of the \textit{least absolute deviation} (LAD), Series:V16. \href{http://gretl.sourceforge.net/}{Gretl}. Page: $<$\pageref{page-tab12}$>$}
	\begin{center}
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Plot illustrating polynomial trend for spectral reflectance of seawater without sediments (Ligaria Beach), variable V15. \href{http://gretl.sourceforge.net/}{Gretl} modelling visualization­. Page: $<$\pageref{page-ave}$>$}\label{fig:A.32}
	\end{center}	
\end{figure}

\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.4]{G-polynom-trend-with.jpg}
		\caption{Plot illustrating polynomial trend for spectral reflectance of seawater with sediments (Ligaria Beach), variable V15. \href{http://gretl.sourceforge.net/}{Gretl} modelling visualization. Page: $<$\pageref{page-ave}$>$­}\label{fig:A.33}
	\end{center}	
\end{figure}
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.4]{G-exp-mov-aver.jpg}
		\caption{Exponential moving average of spectral reflectance of seawater with sediments (Ligaria Beach), variable V15. \href{http://gretl.sourceforge.net/}{Gretl} modelling visualization. Page: $<$\pageref{page-ave}$>$­}\label{fig:A.34}
	\end{center}	
\end{figure}
\pagebreak
%%%end Plot Gretl
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Frequency normality test against gamma distribution: radiance of the seawater, measured in aquarium tank. Visualization in \href{http://gretl.sourceforge.net/}{Gretl}. Page: $<$\pageref{page-norm}$>$}
		\label{fig:A.19}
	\end{center}
\end{figure}
\begin{figure}[H]
	...
	\caption{Frequency normality test against normal distribution: radiance of the seawater, measured in aquarium tank. Visualization in \href{http://gretl.sourceforge.net/}{Gretl}. Page: $<$\pageref{page-norm}$>$­}
	\label{fig:A.20}
\end{figure}
...
\begin{table}[htbp]
	...
	\caption{Results of the statistical analysis of spectral reflectance of \textit{P.oceanica}, with average values (for sets 1 - 350). Generalisation up to step 20 nm. Pages: $<$\pageref{page-40}$>$, $<$\pageref{last}$>$}\label{tab:4.1}
	\begin{center}
...
\begin{table}[H]\footnotesize
	\rowcolors{1}{Ivory}{GhostWhite}
	\caption{Model summary of the \textit{regression} analysis: curve estimation and ANOVA table tested for single observations within one measurement set: spectral reflectance of \textit{P.oceanica}. \ac{SPSS}. Page: $<$\pageref{page-reg}$>$}\label{tab:5}
	\begin{center}
...
\begin{table}[H]\footnotesize
	\rowcolors{1}{Ivory}{GhostWhite}
	\caption{\textit{ANOVA} table: exponential curve estimation in the regression analysis, tested for single observations within one measurement set: spectral reflectance of \textit{P.oceanica}. \ac{SPSS}. Pages: $<$\pageref{page-reg}$>$, $<$\pageref{secondq}$>$}\label{tab:6}
	\begin{center}
...
\begin{table}[H]\footnotesize
	\rowcolors{1}{Ivory}{GhostWhite}
	\caption{Coefficients of the \textit{regression analysis} (exponential curve estimation) of the spectral reflectance of \textit{P.oceanica}. \href{http://www.spss.com/}{SPSS}. Page: $<$\pageref{page-reg}$>$}\label{tab:7}
	\begin{center}
...
\rowcolors{1}{GhostWhite}{LightCyan}\footnotesize
\begin{longtable}{|c|c|c|c|c|c|c|}
	\caption{Results of the statistical analysis of spectral reflectance of \textit{P.oceanica}, sets 1-350). Wavelength step: 3 nm. Measured on Agia Pelagia beach, 15th October. Pages: $<$\pageref{page-28}$>$, $<$\pageref{page-40}$>$, $<$\pageref{last}$>$}\label{tab:A.8} \\
...
\begin{table}[H]\footnotesize
	\rowcolors{1}{Ivory}{GhostWhite}
	\caption{Results of the \textit{autocorrelation analysis} of the measurement set 1-16 of the spectral reflectance of \textit{P.oceanica} (15.X.), Series:V3. \href{http://www.spss.com/}{SPSS}. Page $<$\pageref{page-a-c}$>$}
	\begin{center}
	\begin{tabular}{|c|c|c|c|c|c|}
		\hline\hline
...
\begin{table}[H]
	...
	\begin{center}
		\caption{\textit{Ordinary Least Squares}: results of the \textit{OLS} analysis of the measurement set 326-350 of the spectral reflectance of \textit{P.oceanica} (15.X.). \href{http://gretl.sourceforge.net/}{Gretl}. Page: $<$\pageref{page-OLS}$>$}
...
\begin{figure}[H]
	\centering
	\subfloat [CZCS]{\label{fig:29a}\includegraphics[width=0.4\textwidth]{Fig-35a.jpg}}
	\subfloat [MERIS]{\label{fig:29b}\includegraphics[width=0.4\textwidth]{Fig-35b.jpg}}\\
	\subfloat [MODIS]{\label{fig:29c}\includegraphics[width=0.4\textwidth]{Fig-35c.jpg}}
	\subfloat [SeaWiFS]{\label{fig:29d}\includegraphics[width=0.4\textwidth]{Fig-35d.jpg}}
	\caption{WASI-simulated remote sensing reflectance of \textit{P.oceanica} at various sensors. Pages: $<$\pageref{page-33}$>$, $<$\pageref{secondq}$>$}
	\label{fig:4.6W}
\end{figure}
...
\begin{table}[H]
	...
	\begin{center}
		\caption{Summary statistics of measurements set: 301-325. \\ Example of selected variables 12-22. \href{http://gretl.sourceforge.net/}{Gretl}. Page: $<$\pageref{page-sumstat}$>$­}\label{tab:16}
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Spectral reflectance of \textit{P.oceanica}. Measurement series 25-50. \\ \href{http://www.gnuplot.info/}{Gnuplot} display. Pages: $<$\pageref{page-21}$>$, $<$\pageref{dataprep}$>$­, $<$\pageref{secondq}$>$}
		\label{fig:A.25}
	\end{center}
\end{figure}
\pagebreak
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Remote sensing reflectance of \textit{P.oceanica}. Series 1-25. \\Shown midspread of the statistical quartiles Q1 and Q3 (vertical dashes) and mean value within the range. \\ \href{http://www.gnuplot.info/}{Gnuplot}­. Page: $<$\pageref{page-21}$>$, $<$\pageref{secondq}$>$}
		\label{fig:A.26}
	\end{center}
\end{figure}
...
\begin{table}[H]
	\rowcolors{1}{Ivory}{GhostWhite}
	\caption{Final Cluster Centers: results of the \textit{K-means} analysis of the measurement set 201-236 of the spectral reflectance of \textit{P.oceanica} (15.X.).  \href{http://www.spss.com/}{SPSS}. Page: $<$\pageref{page-fincc}$>$}\label{tab:23}
	\begin{center}
	\begin{tabular}{|c|c|c|c|c|c|}
	\hline\hline
		& \multicolumn{2}{|c|}{Cluster} &  & \multicolumn{2}{|c|}{Cluster}\\
...
\begin{table}[H]
	...
	\begin{center}
	\caption{Results of the \textit{Weighted Least Squares Analysis} applied towards variables 12-20 from the selected dataset 301-325 of the spectral reflectance of \textit{P.oceanica}. \href{http://gretl.sourceforge.net/}{Gretl}. Page: $<$\pageref{page-WLS}$>$}\label{tab:27}
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Normal Q-Q plot: estimated versus observed values of the measurement of \textit{carbonate sand}, variable 27. Series 51-75. \href{http://gretl.sourceforge.net/}{Gretl} modelling visualization­. Page: $<$\pageref{page-A30}$>$}
	\label{fig:A.30}
	\end{center}
\end{figure}
...
\begin{longtable}{|r|r|r|r|r|r|r|}
	\caption{Results of the statistical analysis of spectral reflectance of \textit{carbonate sand}, with average values (for sets 1-3). Wavelength step: 3 nm. Measured on Agia Pelagia beach, 14th October. Pages: $<$\pageref{page-40}$>$, $<$\pageref{last}$>$}\label{tab:A.29} \\
 		 \multicolumn{1}{|l|}{\textbf{wl}} &
  		 \multicolumn{1}{l|}{\textbf{min}} & 
  		 \multicolumn{1}{l|}{\textbf{Q1}} & 
  		 \multicolumn{1}{l|}{\textbf{mean}} & 
	...
	\multicolumn{7}{c}{Table A.29: Spectral reflectance of \textbf{carbonate sand} \textit{(continued from previous page)}}\\
...
\begin{table}[H]
	\begin{small}
	\rowcolors{1}{Ivory}{LightGoldenrodYellow}
	\caption{Results of the \textit{periodogram} for v30 of the measurement set 51-75 of the spectral reflectance of \textit{carbonate sand}, \href{http://gretl.sourceforge.net/}{Gretl}. Page: $<$\pageref{page-period}$>$}
	\label{tab:30}
	\begin{center}
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Plot illustrating periodogram for v30 from measurements of \textit{carbonate sand}, series 51-75. \href{http://gretl.sourceforge.net/}{Gretl} modelling visualization.  Page: $<$\pageref{page-A31}$>$­­}\label{fig:A.31}
	\end{center}	
\end{figure}
\begin{figure}[H]
	\begin{center}
...
%\appendixname{\textbf{8:\\ Satellite and aerial images covering research area of Crete island: selected examples}}
...
\begin{table}[H]\footnotesize
	\caption{Available broadband Landsat satellite images covering the research area of Crete Island. Page: $<$\pageref{page-30}$>$}\label{tab:34}
	\centering
	\rowcolors{1}{Ivory}{GhostWhite}
...
\begin{figure}[H]\footnotesize
	...
	\hspace{1mm}
	\subfloat [Landsat-ETM-99-08-08]{\includegraphics[width=0.3\textwidth]{Landsat10.jpg}}
	\caption{Landsat imagery, Crete Island. Previews. Page: $<$\pageref{page-30}$>$}
	\label{fig:A.38}
\end{figure}
\pagebreak
\newpage
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{The point querying shows the selected points and their coordinates within the area of seagrass meadow (green). \href{http://openev.sourceforge.net/}{OpenEV}.Page: $<$\pageref{page-A45-47}$>$}\label{fig:A.39}	
	\end{center}	
\end{figure}
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.23]{OpenEV-3.jpg}
	\caption{\textit{Logarithmic Enhancement to Raster}, applied to the aerial Google Earth image: the seagrass meadow seen as a bright spot of purple color. \href{http://openev.sourceforge.net/}{OpenEV}. Page: $<$\pageref{page-A45-47}$>$}\label{fig:A.40}	
	\end{center}	
\end{figure}
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.25]{OpenEV-1.jpg}
		\caption{Raster properties dialog: visualization and spatial info about the image (projection UTM, zone 35, datum WGS-84, etc.)  \href{http://openev.sourceforge.net/}{OpenEV}). Page: $<$\pageref{page-A45-47}$>$}\label{fig:A.41}	
	\end{center}	
\end{figure}
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.25]{Ilwis-2.jpg}
		\caption{Color composite image composed of 3 images of Cretan shelf, Google Earth. \href{http://www.ilwis.org/}{ILWIS}. Page: $<$\pageref{page-A45-47}$>$}\label{fig:A.42}	
	\end{center}	
\end{figure}
\begin{figure}[H]
	\begin{center}
...
\begin{figure}[H]
	...
	\caption{Adjusting waterproof Olympus cameras for underwater seafloor videometric measurements.\\Dr. \textit{Petros Lymberakis}\index[people]{Lymberakis, P.} (left) and Dr. \textit{Bert Toxopeus}\index[people]{Toxopeus, A.G.} (right). Pages: $<$\pageref{page-25}$>$, $<$\pageref{page-27}$>$}
	\label{fig:A.51}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Placing the 0.5m circle and depth marker in the mattte of \textit{P.oceanica} for photo capture. Page: $<$\pageref{page-A55}$>$}
	\label{fig:A.55}
\end{figure}
...
\addcontentsline{toc}{section}{\textbf{Bibliography}}\label{bib}
\bibliographystyle{plainnat}
\pagenumbering{alph}
\markright{Bibliography}

\bibitem{Ackleson2003}Ackleson S.\index[people]{} 2003. \emph{Light in shallow waters: A brief research review}. Limnol. Oceanogr.,
48(1, part 2), 2003, 323–328. American Society of Limnology and Oceanography, Inc. \pageref{Ackleson, 2003}
\bibitem{Alcoverro1997} %
Alcoverro T.\index[people]{Alcoverro, T.}, Romero J.\index[people]{Romero J.}, Duarte C.M.\index[people]{Duarte C.M.}, Lopez N.\index[people]{Lopez, N.} 1997. \emph{Spatial and temporal variations
...
\bibitem{Amoutzopoulou-Schina05}Amoutzopoulou-Schina H.\index[people]{Amoutzopoulou-Schina, H.} and Haritonidis S.\index[people]{Haritonidis, S.} 2005. \emph{Distribution and phenology of the marine phanerogam \textit{Posidonia oceanica} in the Pagassitikos Gulf, Greece}. Journal of
Biological Research 4: 203 – 211, 2005 J. \pageref{Amoutzopoulou-Schina05}
\bibitem{Arai05}
Arai K.\index[people]{Arai, K.} and Tonooka H.\index[people]{Tonooka, H.} 2005. \emph{Radiometric Performance Evaluation of \ac{ASTER} VNIR, \ac{SWIR} and \ac{TIR}} 
IEEE Transactions on Geoscience and Remote Sensing, Vol. 43, No. 12, Dec. 2005. \pageref{Arai05}
\bibitem{Ardizzone06}
Ardizzone G.D.\index[people]{Ardizzone G.D.}, Belluscio A.\index[people]{Belluscio A.} and Maiorano L.\index[people]{Maiorano, L.} 2006. \emph{Long-term change in the structure of
...
\bibitem{Ball09}
Ball D.\index[people]{Ball, D.}, Soto-Berelov M.\index[people]{Soto-Berelov, M.}, Young P.\index[people]{Young, P.} and Coots A.\index[people]{Coots, A.} 2009. \emph{Baywide Seagrass Monitoring Program - Historical Seagrass Mapping}. Fisheries Victoria Technical Report Series No. 70. \pageref{Ball09}
\bibitem{Barille09}
Barille L.\index[people]{Barille, L.}, Robin M.\index[people]{Robin, M.}, Harin N.\index[people]{Harin, N.}, Bargain A.\index[people]{Bargain, A.}, Patrick L.\index[people]{Patrick, L.} 2009. \emph{Increase in seagrass distribution at Bourgneuf Bay (France) detected by spatial remote sensing}. Aquatic Botany. \pageref{Barille09}
\bibitem{Bakran-Petricioli06} %
Bakran-Petricioli T.\index[people]{Bakran-Petricioli, T.}, Antonic O.\index[people]{Antonic, O.}, Bukovec D.\index[people]{Bukovec, D.}, Petricioli D.\index[people]{Petricioli, D.}, Janekovic I.\index[people]{Janekovic, I.}, Krizan J.\index[people]{Krizan, J.}, Kusan V.\index[people]{Kusan, V.} and Dujmovic S.\index[people]{Dujmovic, S.} 2006. \emph{Modelling spatial distribution of the Croatian marine
benthic habitats}. Ecological Modelling 191, 96–105. \pageref{Bakran-Petricioli06}
\bibitem{Bell99}
Bell S.S.\index[people]{Bell S.S.}, Robbins B.D.\index[people]{Robbins B.D.} and Jensen S.L.\index[people]{Jensen S.L.} 1999. \emph{Gap Dynamics in a Seagrass Landscape}.
Springer-Verlag. Ecosystems (1999) 2: 493–504. \pageref{Bell99}
\bibitem{Bierwirth93}
Bierwirth P. N.\index[people]{Bierwirth, P. N.}, Lee T. J.\index[people]{Lee, T. J.} and Burne R. V.\index[people]{Burne, R.V.} 1993. \emph{Shalow sea-floor reflectance and water
...
\bibitem{Blake00}
Blake S.\index[people]{Blake, S.}, Roob R.\index[people]{Roob, R.} and Patterson E.\index[people]{Patterson, E.} 2000. \emph{Seagrass mapping of Victoria's Minor Inlets}.
Marine and Freshwater Resources Institute Report No. 28. \pageref{Blake00}
\bibitem{Borum04}
Borum J.\index[people]{Borum, J.}, Duarte C.M.\index[people]{Duarte C.M.}, Krause-Jensen D.\index[people]{Krause-Jensen, D.} and Greve T.M.\index[people]{Greve, T.M} 2004. \emph{European seagrasses: an introduction to monitoring and management}. The M and MS project. ISBN: 87-89143-21-3.
Internet version: Available at \href{http://www.seagrasses.org}{Seagrasses.org} \pageref{Borum04}
\bibitem{Brown02}
Brown C.J.\index[people]{Brown, C.J.}, Cooper K.M.\index[people]{Cooper, K.M.}, Meadows W.J.\index[people]{Meadows, W.J.}, Limpenny D.S.\index[people]{Limpenny, D.S.}, Rees H.L.\index[people]{Rees, H.L.} 2002. \emph{Small scale mapping of sea bed assemblages in the eastern English Channel using sonar and remote
sampling techniques}. Estuarine Coastal and Shelf Science, 54, 263-278. \pageref{Brown02}
\bibitem{Boudouresque89}
Boudouresque C.F.\index[people]{Boudouresque C.F.}, Meinesz, A.\index[people]{Meinesz A.}, Fresi, E.\index[people]{Fresi, E.} and Gravez, V.\index[people]{Gravez, V}, 1989. \emph{2nd International Workshop on \textit{Posidonia oceanica} Beds}. G.I.S. Posidonie, Oceanica, 2, 322 pp. \pageref{Boudouresque89}
\bibitem{Bharathi03}
Bharathi A.M.\index[people]{Bharathi A.M.}, Kumar S.C.\index[people]{Kumar S.C.}, Kalliappan S.\index[people]{Kalliappan S.} 2003. \emph{Target Identification in multispectral images using \textit{in-situ} hyperspectral reflectance}. The Geospatial Resource Portal. Remote Sensing.
\href{www.gisdevelopment.net}{gisdevelopment} \pageref{Bharathi03}
\bibitem{Buia91}
Buia M.C.\index[people]{Buia M.C.} and Mazzella L.\index[people]{Mazzella L.} 1991. \emph{Reproductive phenology of the Mediterranean
...
\bibitem{Butler87}
Butler\index[people]{Butler} 1987. \emph{Marine resource mapping: an introductory manual}. \pageref{Butler87}
\bibitem{Cappo95}
Cappo M.\index[people]{Cappo, M.}, Alongi D.M.\index[people]{Alongi D.M.}, Williams D.\index[people]{Williams D.} and Duke N.\index[people]{Duke N.} 1995. \emph{A Review and Synthesis of Australian Fisheries Habitat Research: Major threats, issues and gaps in knowledge of
coastal and marine fisheries habitats}. Fisheries Research and Development Corporation. \pageref{Cappo95}
\bibitem{Carter08}
Carter G.A.\index[people]{Carter G.A.}, Criss G.A.\index[people]{Criss G.A.}, Blossom G.A.\index[people]{Blossom G.A.} and Biber P.D.\index[people]{Biber P.D.} 2008. \emph{Decadal-Scale Changes in Coverage on the Mississippi Barrier Islands, Northern Gulf of Mexico}.
\href{http://precedings.nature.com/documents/3669/version/1/files/npre20093669-1.pdf}{precedings.nature.com} \pageref{Carter08}
\bibitem{Calvo03}
Calvo S.\index[people]{Calvo S.}, Ciraolo G.\index[people]{Ciraolo G.} and Loggia G. la\index[people]{Loggia G. la}. 2003. \emph{Monitoring \textit{Posidonia oceanica} meadows in a Mediterranean coastal lagoon (Stagnone, Italy) by means of neural network and
ISODATA classification methods}. INT. J. REMOTE SENSING, 2003, VOL. 24, NO. 13,
2703–2716 \pageref{Calvo03}
\bibitem{Cambridge09}
Cambridge M.L.\index[people]{Cambridge M.L.}, Kendrick G.A.\index[people]{Kendrick G.A.} 2009. \emph{Contrasting responses of seagrass transplants
...
\bibitem{Choo06}
Choo, C.K.\index[people]{Choo, C.K.} 2006. \emph{Save our Seahorses}. First Edition. \href{www.sosmalaysia.org}{sosmalaysia} \pageref{Choo06}
\bibitem{Clark99}
Clark, R.N.\index[people]{Clark, R.N.}, 1999. \emph{Spectroscopy of rocks and minerals and principles of spectroscopy}.
In: A.N. Rencz (ed.). Manual of Remote Sensing, Chapter 1, John Wiley and Sons, New York. 3-58. \pageref{Choo06}
\bibitem{Connell78}
Connell J.H.\index[people]{Connell J.H.} 1978. \emph{Diversity in tropical rain forests and coral reefs}. Science 199:1302–
10. \pageref{Connell78}
\bibitem{Dehouck08}
Dehouck A.\index[people]{Dehouck A.}, Martiny N.\index[people]{Martiny N.}, Froidefond J.-M.\index[people]{Froidefond J.-M.}, S\'en\'echal N.\index[people]{S\'en\'echal N.} 2008. \emph{In-Water Reflectance Spectra Measured On Board a Jet-Ski Across a Complex Nearshore Zone of Case-2 Waters during the ECORS Experiment}. Manuscript published in "Ocean Optics XIX, Barga: Italie
(2008)" \pageref{Dehouck08}
\bibitem{Dekker05a}
Dekker A.G.\index[people]{Dekker A.G.}, Brando V.E.\index[people]{Brando V.E.}, Anstee J.M.\index[people]{Anstee J.M.} 2005. \emph{Retrospective seagrass change detection in a shallow coastal tidal Australian lake}. Remote Sensing of Environment 97:415-433. \pageref{Dekker05a}
\bibitem{Dekker05b}
Dekker A.\index[people]{Dekker A.G.}, Brando V.E.\index[people]{Brando V.E.}, Anstee J.M.\index[people]{Anstee J.M.} 2005. \emph{Remote Sensing of Seagrass Ecosystems: Use of Spaceborne and Airborne Sensors}. SVNL083-Larkum. \pageref{Dekker05b}
\bibitem{DiCarlo04}
Di Carlo G.\index[people]{Di Carlo G.} 2004. \emph{The natural recolonisation process of the seagrass Posidonia
...
Diaz-Almela E.\index[people]{Diaz-Almela E.}, Marb\`a N.\index[people]{Marb\`a N.}, Alvarez E.\index[people]{Alvarez E.}, Santiago R.\index[people]{Santiago R.}, Holmer M.\index[people]{Holmer M.}, Grau A.\index[people]{Grau A.}, Danovaro R.\index[people]{Danovaro R.}, Argyrou M.\index[people]{Argyrou M.}, Karakassis I.\index[people]{Karakassis I.}, Duarte C.M.\index[people]{Duarte C.M.} 2006. \emph{Benthic inputs as predictors of seagrass (\textit{Posidonia oceanica}) fish farm-induced decline}. \href{http://arxiv.org/ftp/qbio/papers/0611/0611006.pdf}{arxiv.org} \pageref{Diaz-Almela06}
\bibitem{Dierssen03}
Dierssen H.\index[people]{Dierssen H.} and Zimmerman R.C.\index[people]{Zimmerman R.C.} 2003. \emph{Ocean color remote sensing of seagrass and
...
\bibitem{Dixon05}
Dixon R.\index[people]{Dixon R.}, editor. 2005. \emph{Watching the Seagrass Grow – a guide for community seagrass
monitoring in NSW (2nd Ed)}. Reference manual . The Community Environment Network,
Ourimbah. \pageref{Dixon05}
\bibitem{Duarte02}
Duarte, C.M.\index[people]{Duarte C.M.} 2002. \emph{The future of seagrass meadows}. Environmental Conservation 29 (2), 192–206. \pageref{Duarte02}
\bibitem{Dumay02}
Dumay O.\index[people]{Dumay O.}, Fernandez C.\index[people]{Fernandez C.} and Pergent G.\index[people]{Pergent G.} 2002. \emph{Primary production and vegetative cycle in \textit{Posidonia oceanica} when in competition with the green algae Caulerpa taxifolia nd
Caulerpa racemosa}. J.Mar. Biol. Ass. UK, 82, 379-387. \pageref{Dumay02}
\bibitem{Dural10}
Dural B.\index[people]{Dural B.} 2010. \emph{Phenological observations on \textit{Posidonia oceanica} (L.) Delile medows
...
\bibitem{Edwards00}
Edwards A.J.\index[people]{Edwards A.J.} (ed.) 2000. \emph{Remote Sensing handbook for tropical coastal management}.
\href{http://www.unesco.org/csi/pub/source/rs.htm}{UNESCO} \pageref{Edwards00}
\bibitem{Ferguson97}
Ferguson R.L.\index[people]{Ferguson R.L.} and Karl Korfmacher K.\index[people]{Korfmacher Karl K.} 1997 \emph{Remote sensing and GIS analysis of seagrass meadows in North Carolina, USA}. Aquatic Botany 58 (1997) 241-258. \pageref{Ferguson97}
\bibitem{Fletcher09}
Fletcher R.S.\index[people]{Fletcher R.S.}, Pulich Jr. W.\index[people]{Pulich Jr. W.} and Hardegree B.\index[people]{Hardegree B.} 2009. \emph{A Semiautomated Approach for Monitoring Landscape Changes in Texas Seagrass Beds from Aerial Photography}. Coastal
Education and Research Foundation, doi: 10.2112/07-0882.1 \pageref{Fletcher09}
\bibitem{Fornes06}
Fornes A.\index[people]{Fornes A.}, Basterretxea G.\index[people]{Basterretxea G.}, Orfila A.\index[people]{Orfila A.}, Jordi A.\index[people]{Jordi A.}, Alvarez A.\index[people]{Alvarez A.} and Tintore J.\index[people]{Tintore J.} 2006. \emph{Mapping
\textit{Posidonia oceanica} from IKONOS}. ISPRS Journal of Photogrammetry and Remote Sensing
60 (2006) 315–322. \pageref{Fornes06}
\bibitem{Francour06}
Francour, P.\index[people]{Francour P.}, Magreau, J.F.\index[people]{Magreau, J.F.}, Mannoni, P.A.\index[people]{Mannoni, P.A.}, Cottalorda, J.M.\index[people]{Cottalorda, J.M}, Gratiot, J.\index[people]{Gratiot, J.}, 2006.\emph{Management guide for Marine Protected Areas of the Mediterranean Sea, Permanent Ecological Moorings}. Universite de Nice-Sophia Antipolis and Parc National de Port-Cros,
Nice, 68 pp. \pageref{Francour06}
\bibitem{Francour99}
Francour P.\index[people]{Francour P.}, Ganteaume A.\index[people]{Ganteaume A.} and M. Poulain\index[people]{Poulain M.}. 1999. \emph{Effects of boats anchoring in \textit{Posidonia oceanica} seagrass beds in the Port-Cross National Park (north-western
Mediterranean Sea)}. Aquatic conservation: Marine and Freshwater Ecosystems: 9: 391-400. \pageref{Francour99}
\bibitem{Fyfe03}
Fyfe S.K.\index[people]{Fyfe S.K.} 2003. \emph{Spatial and temporal variation in spectral reflectance: Are seagrass
species spectrally distinct?} Limnology and Oceanography 48: 464–479. \pageref{Fyfe03}
\bibitem{Fyfe04}
Fyfe S.K.\index[people]{Fyfe S.K.} 2004. \emph{Hyperspectral studies of New South Wales with particular emphasis on
...
\bibitem{Gege04}
Gege P.\index[people]{Gege P.} 2004. \emph{The water color simulator WASI: an integrating software tool for analysis
and simulation of optical in situ spectra}. Computers and Geosciences 30 (2004) 523–532. \pageref{Gege04}
\bibitem{Gege05}
Gege, P.\index[people]{Gege P.} 2005. \emph{The Water Colour Simulator WASI. User manual for version 3}. DLR
Internal Report IB 564-01/05, 83 pp. \pageref{Gege05}
\bibitem{Gobert06}
Gobert S.\index[people]{Gobert S.}, Cambridge, M. L.\index[people]{Cambridge M.L.}, Velimirov, B.\index[people]{Velimirov B.}, Pergent, G.\index[people]{Pergent G.}, Lepoint, G.\index[people]{Lepoint G.}, Bouquegneau J.-M.\index[people]{Bouquegneau J.-M.}, Dauby, P.\index[people]{Dauby, P.}, Pergent-Martini, C.\index[people]{Pergent-Martini C.}, Walker, D. I.\index[people]{Walker, D.I.}. 2006. Biology of Posidonia. In Larkum A.W.D.\index[people]{Larkum A.W.D}, Orth, R.J.\index[people]{Orth R.J.}, Duarte C.M.\index[people]{Duarte C.M.} (eds.), \emph{Seagrasses: Biology, ecology and conservation}. Springer Verlag, Berlin, Pages 387–408. \pageref{Gobert06}
\bibitem{Gobert01}
Gobert S.\index[people]{Gobert S.}, Defawe O.\index[people]{Defawe O.}, Lepoint G.\index[people]{Lepoint G.}, Demoulin V.\index[people]{Demoulin V.} and Bouquegneau J.-M.\index[people]{Bouquegneau J.-M.} 2001. \emph{Anthesis effects on \textit{Posidonia oceanica} (L.) Delile phenology in the Bay of Calvi (Corsica, Mediterranean Sea)}. Hydrobiologia 455: 121–125. \pageref{Gobert01}
\bibitem{Green96}
Green, E.P.\index[people]{Green E.P.}, Mumby P.J.\index[people]{Mumby P.J.}, Edwards  A.J.\index[people]{Edwards A.J.}, and Clark C.D.\index[people]{Clark C.D.}, 1996. \emph{A review of remote sensing for the assessment and management of tropical coastal resources}. Coast. Manag.,
24(1):1-40. \pageref{Green96}
\bibitem{Green03}
Green E.P.\index[people]{Green E.P.}, Short F.T.\index[people]{Short F.T.} 2003. \emph{World Atlas of Seagrasses}. University of California Press,
Berkeley, USA. \pageref{Green03}
\bibitem{Guidetti08}
Guidetti P.\index[people]{Guidetti P.} 2008. \emph{Population dynamics of the seagrass \textit{Posidonia oceanica} for
...
Gullstroom M.\index[people]{Gullstroom M.}, Lunden B.\index[people]{Lunden B.}, Bodin M.\index[people]{Bodin M.}, Kangwe J.\index[people]{Kangwe J.}, Ohman M.C.\index[people]{Ohman M.C.}, Mtolera M.S.P.\index[people]{Mtolera M.S.P.} and Bjork M.\index[people]{Bjork M.} 2006. \emph{Assessment of changes in the seagrass-dominated submerged vegetation of tropical Chwaka Bay (Zanzibar) using satellite remote sensing}. Estuarine, Coastal and Shelf
Science 67 (2006) 399-408. \pageref{Gullstroom06}
\bibitem{Haag08}
Haag S.M.\index[people]{Haag S.M.}, Kennish M.\index[people]{Kennish M.}, Sakowicz G.P.\index[people]{Sakowicz G.P.} 2008. \emph{Seagrass Habitat Characterization in Estuarine Waters of the Jacques Cousteau National Estuarine Research Reserve Using
...
\bibitem{DenHartog70}
Den Hartog, C.\index[people]{Den Hartog C.} 1970. \emph{The Seagrasses of the World}. North Holland Publishing Company,
Amsterdam, 275 pp. 31 plates. \pageref{DenHartog70}
\bibitem{DenHartog77}
Den Hartog, C.\index[people]{Den Hartog C.}, 1977. \emph{Structure, function, and classification in seagrass communities}.
In: C.P. McRoy\index[people]{McRoy, C.P.} and C. Helfferich\index[people]{Helfferich C.} (Editors), Seagrass Ecosystems: a Scientific Perspective.
Marcel, New York, pp. 89-121. \pageref{DenHartog77}
\bibitem{Heege03}
Heege T.\index[people]{Heege T.}, Bogner A.\index[people]{Bogner A.}, Pinnel N.\index[people]{Pinnel N.} 2003. \emph{Mapping of submerged aquatic vegetation with a physically based process chain}. Proc. Remote Sensing, September 8-12 2--3/ Barcelona,
Spain. Ed. by Kramer E.\index[people]{Kramer E.} The International Society for Optical Engineering, Vol.5233. \pageref{Heege03}
\bibitem{Hirose04}
Hirose K.\index[people]{Hirose K.}, Syoji M.\index[people]{Syoji M.}, Hang H.T.M.\index[people]{Hang H.T.M.}, Anh N.H.\index[people]{Anh N.H.}, Triet T.\index[people]{Triet T} and Nam V.N.\index[people]{Nam V.N.} 2004. \emph{Satellite data application for mangrove management}. International Symposium on Geoinfomatics for Spatial Infrastructure Development in Earth and Allied Sciences. \pageref{Hirose04} 
\bibitem{Hochberg03a}
Hochberg, E.J.\index[people]{Hochberg E.J.}, Atkinson, M.J.\index[people]{Atkinson, M.J.} 2003a. \emph{Capabilities of remote sensors to classify coral,
algae, and sand as pure and mixed spectra}. Remote Sensing of Environment 85, 174–189. \pageref{Hochberg03a}
\bibitem{Hochberg03b}
Hochberg, E.J.\index[people]{Hochberg E.J.}, Atkinson, M.J.\index[people]{Atkinson, M.J.}, Andr\'efou\"et, S.\index[people]{Andr\'efou\"et S.}, 2003b. \emph{Spectral reflectance of coral reef bottom-types worldwide and implications for coral reef remote sensing}. Remote Sensing of
Environment 85, 159–173. \pageref{Hochberg03b}
\bibitem{Hogarth07}
Hogarth P.\index[people]{Hogarth P.} 2007. \emph{The Biology of Mangroves and Seagrasses}. Oxford University Press. \pageref{Hogarth07}
\bibitem{Holmer09}
Holmer M.\index[people]{Holmer M.}, Marb\`a N.\index[people]{Marb\`a N.}, Lamote M.\index[people]{Lamote M.} and Duarte C.\index[people]{Duarte C.M.} 2009\emph{Deterioration of Sediment Quality in Seagrass Meadows (\textit{Posidonia oceanica}) Invaded by Macroalgae (Caulerpa sp.)}. Estuaries
and Coasts (2009) 32:456–466 DOI 10.1007/s12237-009-9133-4 \pageref{Hogarth07}
\bibitem{Holmer08}
Holmer M.\index[people]{Holmer M.}, Argyrou M.\index[people]{Argyrou M.}, Dalsgaard T.\index[people]{Dalsgaard T.}, Danovaro R.\index[people]{Danovaro R.}, Diaz-Almela E.\index[people]{Diaz-Almela E.}, Duarte C.\index[people]{Duarte C.M.}, Frederiksen M.\index[people]{Frederiksen M.}, Grau A.\index[people]{Grau A.}, Karakassis I.\index[people]{Karakassis I.}, Marb\`a N.\index[people]{Marb\`a N.}, Mirto S.\index[people]{Mirto S.}, P\'erez M.\index[people]{P\'erez M}, Pusceddu A.\index[people]{Pusceddu A.}, Tsapakis M.\index[people]{Tsapakis M.}, 2008
...
\bibitem{Iverson86}
Iverson R.L.\index[people]{Iverson R.L.} and Bittaker H.F.\index[people]{Bittaker H.F.} 1986. \emph{Seagrass Distribution and Abundance in Eastern
Gulf of Mexico Coastal Waters}. Estuarine, Coastal and Shelf Science, 22, 577-602. \pageref{Iverson86}
\bibitem{Jackson07}
Jackson J.\index[people]{Jackson J.}, Nemeth D.J.\index[people]{Nemeth D.J.} 2007. \emph{A New Method to Describe Seagrass Habitat Sampled
During Fisheries-Independent Monitoring}. Estuaries and Coasts Vol. 30, No. 1, p. 171–178 February 2007 \pageref{Jackson07}
\bibitem{Jensen01}
Jensen S.\index[people]{Jensen S.L.} and Bell S.S.\index[people]{Bell S.S.} 2001. \emph{Seagrass growth and patch dynamics: cross-scale
morphological plasticity}. Plant Ecology 155: 201–217, 2001. \pageref{Jensen01}
\bibitem{Jensen95}
Jensen J.R.\index[people]{Jensen J.R.}, Rutchey K.\index[people]{Rutchey K.}, Koch M.S.\index[people]{Koch M.S.}, Narumalani S.\index[people]{Narumalani S.} 1995. \emph{Inland wetland change detection in the everglades water conservation area 2a using a time-series of normalized
remotely-sensed data}. Photogrammetric Eng Remote Sensing 61: 199–209 \pageref{Jensen95}
\bibitem{Jerlov52}
Jerlov N.G.\index[people]{Jerlov N.G.} 1952. \emph{Influence of suspended and dissolved matter on the transparency of
sea water}. Wiley online Library. TellusVolume 5, Issue 1, Published online: 2010. \pageref{Jerlov52}
\bibitem{Kalinowski04}
Kalinowski A.\index[people]{Kalinowski A.} and Oliver S.\index[people]{Oliver S.} \emph{2004 ASTER Mineral Index Processing Manual}. Remote
Sensing Applications. Geoscience Australia \pageref{Kalinowski04}
\bibitem{Kelly80}
Kelly, M.G.\index[people]{Kelly, M.G.}, 1980. \emph{Remote sensing of seagrass beds, Handbook of Seagrass Biology: An
Ecosystem Perspective} (R.C. Phillips\index[people]{Phillips, R.C.} and C.P. McRoy\index[people]{McRoy, C.P.}, editors), Garland STPM Press, New
York, N.Y., pp. 69-86. \pageref{Kelly80}
\bibitem{Kendrick00}
Kendrick G.A.\index[people]{Kendrick G.A.}, Hegge B.J.\index[people]{Hegge B.J.}, Wyllie A.\index[people]{Wyllie A.}, Davidson A.\index[people]{Davidson A.}, Lord D.A.\index[people]{Lord D.A.}. 2000. \emph{Changes in Seagrass Cover on Success and Parmelia Banks, Western Australia Between 1965 and 1995}. Estuarine, Coastal and Shelf Science, 50:341-353. \pageref{Kendrick00}
\bibitem{Kirk94}
Kirk J.T.O.\index[people]{Kirk J.T.O.} 1994. \emph{Light and photosynthesis in aquatic ecosystems}, pp 1–509. University
Press, Cambridge, UK. \pageref{Kirk94}
\bibitem{Kirkman96}
Kirkman H.\index[people]{Kirkman H.} 1996. \emph{Baseline and Monitoring Methods for Seagrass Meadows}. Journal of
Environmental Management (1996) 47, 191–201. \pageref{Kirkman96}
\bibitem{Kuo89}
Kuo J.\index[people]{Kuo J.}, McComb A.J.\index[people]{McComb A.J.}, 1989. \emph{Seagrass taxonomy, structure and development. In: Larkum
A.W.D.\index[people]{Larkum A.W.D.}, McComb A.J.\index[people]{McComb A.J.}, Shepherd J.\index[people]{Shepherd J.}, eds. Biology of seagrasses: a treatise on the biology of seagrasses with special reference to the Australian region}. Elsevier, The Netherlands: 6-73. \pageref{Kuo89}
\bibitem{Leoni06}
Leoni V.\index[people]{Leoni V.}, Pasqualini V.\index[people]{Pasqualini V.}, Pergent-Martini C.\index[people]{Pergent-Martini C.}, Vela A.\index[people]{Vela A.}, Pergent G.\index[people]{Pergent G.} 2006. \emph{Morphological responses of \textit{Posidonia oceanica} to experimental nutrient enrichment of the canopy water}. Journal of Experimental Marine Biology and Ecology xx (2006) xxx–xxx. \pageref{Leoni06}
\bibitem{Leoni07}
Leoni V.\index[people]{Leoni V.}, Pasqualini V.\index[people]{Pasqualini V.}, Pergent-Martini C.\index[people]{Pergent-Martini C.}, Vela A.\index[people]{Vela A.}, Pergent G.\index[people]{Pergent G.} 2007. \emph{Physiological responses of \textit{{Posidonia oceanica}} to experimental nutrient enrichment of the canopy water}. Journal of Experimental Marine Biology and Ecology 349, 73–83. \pageref{Leoni07}
\bibitem{Leoni08}
Leoni V.\index[people]{Leoni V.}, Vela A.\index[people]{Vela A.}, Pasqualini V.\index[people]{Pasqualini V.}, Pergent-Martini C.\index[people]{Pergent-Martini C.}, Pergent G.\index[people]{Pergent G.} 2008. \emph{Effects of experimental reduction of light and nutrient enrichments (N and P) on seagrasses: a review}.
Aquatic Conservation: Marine and Freshwater Ecosystems, 18: 202–220. \pageref{Leoni08}
\bibitem{Lewis01}
Lewis M.\index[people]{Lewis M.} 2001. \emph{Discriminating Vegetation with Hyperspectral Imagery - What is
...
\bibitem{Louchard03}
Louchard E.M.\index[people]{Louchard E.M.}, Reid R.P.\index[people]{Reid R.P.}, Stephens F.C.\index[people]{Stephens F.C.}, Davis C.O.\index[people]{Davis C.O.}, Leathers R.A.\index[people]{Leathers R.A.}, Downes T.V.\index[people]{Downes T.V.} 2003. \emph{Optical remote sensing of benthic habitats and bathymetry in coastal environments at Lee Stocking Island, Bahamas: A comparative spectral classification approach}. Limnology
and Oceanography (2003) 48:511-521. \pageref{Louchard03}
\bibitem{Luque04}
Luque A.\index[people]{Luque A.} and Templado J.A.\index[people]{Templado J.A.} 2004. \emph{Praderas y bosques marinos de Andalucia
Consejeria de Medio Ambiente, Junta de Andalucia} (in press). \pageref{Luque04}
\bibitem{Lyzenga81}
Lyzenga D.R.\index[people]{Lyzenga D.R.} 1981. \emph{Remote sensing of bottom reflectance and water attenuation in
shallow water using aircraft and Landsat data}. International Journal of Remote Sensing 2,
71-82. \pageref{Lyzenga81}
\bibitem{Maffione97}
Maffione R.A.\index[people]{Maffione R.A.} and Dana D.R.\index[people]{Dana D.R.} 1997 \emph{Instruments and methods for measuring the
backward-scattering coefficient of ocean waters}. Optical Society of America \pageref{Maffione97}
\bibitem{Maffione01a}
Maffione R.A.\index[people]{Maffione R.A.} 2001a. \emph{Evolution and Revolution in Measuring Ocean Optical Properties}.
Oceanography, Vol.14, No.3. \pageref{Maffione01a}
\bibitem{Maffione01b}
Maffione R.A.\index[people]{Maffione R.A.} 2001b.\emph{Hyperspectral Optical Properties, Remote Sensing, and
Underwater Visibility}. Hydro-Optics, Biology, and Instrumentation Laboratories. \pageref{Maffione01b}
\bibitem{Malthus03}
Malthus T.J.\index[people]{Malthus T.J.} and Karpouzli E.\index[people]{Karpouzli E.} 2003. \emph{Integrating field and high spatial resolution
...
\bibitem{Matarrese08}
Matarrese R.\index[people]{Matarrese R.}, Acquaro M.\index[people]{Acquaro M.}, Morea A.\index[people]{Morea A.}, Tijani K.\index[people]{Tijani K.}, Chiaradia M.T.\index[people]{Chiaradia M.T.} 2008. \emph{Applications of remote sensing techniques for mapping \textit{{Posidonia oceanica}} meadows}. Geoscience and Remote Sensing Symposium. ISBN:978-1-4244-2807-6. \pageref{Matarrese08}
\bibitem{Matarrese06}
Matarrese R.\index[people]{Matarrese R.}, Acquaro M.\index[people]{Acquaro M.}, Morea A.\index[people]{Morea A.}, Khalid T.\index[people]{Khalid T.}, Chiaradia M.T.\index[people]{Chiaradia M.T.} 2006 \emph{Applications of remote sensing techniques for mapping \textit{{Posidonia oceanica}} meadows}.
...
\bibitem{McKenzie02}
McKenzie L.J.\index[people]{McKenzie L.J.}, Campbell S.J.\index[people]{Campbell S.J.} 2002. \emph{Manual for Community (citizen) Monitoring of
...
\bibitem{McKenzie03}
McKenzie L.J.\index[people]{McKenzie L.J.}, Campbell S.J.\index[people]{Campbell S.J.} and Roder C.A.\index[people]{Roder C.A.} 2003. \emph{Seagrass-Watch: Manual for Mapping and Monitoring Seagrass Resources by Community (citizen) Volunteers}. 2nd Edition. QFS, NFC, Cairns. 100pp. \pageref{McKenzie03}
\bibitem{McKenzieetal03}
McKenzie L.J.\index[people]{McKenzie L.J.} 2003. \emph{Guidelines for the rapid assessment of seagrass habitats in the
...
\bibitem{McKenzie06}
McKenzie L.J.\index[people]{McKenzie L.J.}, Campbell S.J.\index[people]{Campbell S.J.} and F.Lasi\index[people]{Lasi, F.} 2006. \emph{Seagrasses and Mangroves}. In: Green A.P.\index[people]{Green A.P.}, Lokani W.\index[people]{Lokani W.}, Atu P.\index[people]{Atu P.}, Ramonia P.\index[people]{Ramonia P.}, Thomas P.\index[people]{Thomas P.} and Almanmy J.\index[people]{Almanmy J.} (eds). 2006 \emph{Solomon Islands Marine Assessment. Technical report of survey conducted May 13 to June 17 2004}. The Nature Conservancy, Indo-Pacific Resource Centre. Report No 1/06 \pageref{McKenzie06}
\bibitem{McKenzie07}
McKenzie L.J.\index[people]{McKenzie L.J.} and Yoshida R.\index[people]{Yoshida R.} 2007. \emph{Seagrass-Watch: Guidelines for Monitoring
...
\bibitem{McKenzie08}
McKenzie L.J.\index[people]{McKenzie L.J.} 2008. \emph{Seagrass-Watch. Proceedings of a Workshop for Mapping and
...
\bibitem{McKenzie09}
McKenzie L.J.\index[people]{McKenzie L.J.}, Yoshida R.\index[people]{Yoshida R.} 2009. Seagrass Watch. Proceedings of a Workshop for
...
\bibitem{Meinesz91}
Meinesz, A.\index[people]{Meinesz A.}, Lefevre, J.R.\index[people]{Lefevre, J.R.}, Astier, J.M.\index[people]{Astier, J.M.}, 1991. \emph{Impact of coastal development on the infralittoral zone along the south-eastern Mediterranean shore of continental France}. Marine Pollution Bullettin 23, 343–347. \pageref{Meinesz91}
\bibitem{Mellors09a}
Mellors J.\index[people]{Mellors J.} and McKenzie L.\index[people]{McKenzie L.J.} 2009(a). \emph{Seagrass-Watch: Guidelines for Monitoring
Seagrass Habitats. Proceedings of a workshop held on Thursday Island, Torres Strait 4-8.03.2009}. \pageref{Mellors09a}
\bibitem{Mellors09b}
Mellors J.\index[people]{Mellors J.} and McKenzie L.\index[people]{McKenzie L.J.} 2009(b). \emph{Seagrass-Watch: Seagrass Monitoring Guidelines
...
\bibitem{Micheli05}
Micheli C.\index[people]{Micheli C.}, Paganin P.\index[people]{Paganin P.}, Peirano A.\index[people]{Peirano A.}, Caye, G.\index[people]{Caye, G.}, Meinesz A.\index[people]{Meinesz A.} and Bianchi C.N.\index[people]{Bianchi C.N.} 2005. \emph{Genetic variability of \textit{{Posidonia oceanica}} (L.) Delile in relation to local factors and biogeographic patterns}. Aquatic Botany 82 (2005) 210–221 \pageref{Micheli05}
\bibitem{Montefalcone09}
Montefalcone M.\index[people]{Montefalcone M.} 2009.\emph{Ecosystem health assessment using the Mediterranean seagrass
\textit{Posidonia oceanica}: A review}. Ecological indicators 595 – 604 \pageref{Montefalcone09}
\bibitem{Montefalcone10}
Montefalcone M.\index[people]{Montefalcone M.}, Albertelli G.\index[people]{Albertelli G.}, Morri C.\index[people]{Morri C.} and Bianchi C.N.\index[people]{Bianchi C.N.} 2010. \emph{Patterns of wide-scale substitution within meadows of the seagrass \textit{{Posidonia oceanica}} in NW Mediterranean Sea:
...
Montefalcone M.\index[people]{Montefalcone M.}, Albertelli G.\index[people]{Albertelli G.}, Bianchi C.N.\index[people]{Bianchi C.N.}, Mariani M.\index[people]{Mariani M.}, Morri C.\index[people]{Morri C.} 2006. \emph{A new synthetic index and a protocol for monitoring the status of \textit{{Posidonia oceanica}} meadows: a case study at Sanremo (Ligurian Sea, NW Mediterranean)}. Aquatic Conservation: Marine and Freshwater Ecosystems, 16, 29–42. \pageref{Montefalcone06}
\bibitem{Mount03}
Mount R.\index[people]{Mount R.} 2003. \emph{The application of digital aerial photography to shallow water seabed
...
\bibitem{Mumby99}
Mumby P.J.\index[people]{Mumby P.J.}, Green E.P.\index[people]{Green E.P.}, Edwards A.J.\index[people]{Edwards A.J.} and Clark C.D.\index[people]{Clark C.D.} 1999. \emph{The cost-effectiveness of remote sensing for tropical coastal resources assessment and management}. Journal of Environmental Management Volume 55, Issue 3, March 1999, Pages 157-166 \pageref{Mumby99}
\bibitem{Mumby02}
Mumby, P.J.\index[people]{Mumby P.J.} and Edwards A.J.\index[people]{Edwards A.J.} 2002. \emph{Mapping marine environments with IKONOS
...
\bibitem{Mumby04}
Mumby P.J.\index[people]{Mumby P.J.}, Skirving W.\index[people]{Skirving W.}, Strong A.E.\index[people]{Strong A.E.}, Hardy J.T.\index[people]{Hardy J.T.}, LeDrew E.F.\index[people]{LeDrew E.F.}, Hochberg E.J.\index[people]{Hochberg E.J.}, Stumpf R.P.\index[people]{Stumpf R.P.} and David L.T.\index[people]{David L.T.} 2004. \emph{Remote sensing of coral reefs and their physical environment}. Marine Pollution Bulletin, 48:219-228. \pageref{Mumby04}
\bibitem{Nagelkerken00}
Nagelkerken I.\index[people]{Nagelkerken I.}, van der Velde G.\index[people]{van der Velde G.}, Gorissen M.W.\index[people]{Gorissen M.W.}, Meijer G.J.\index[people]{Meijer G.J}, van’t Hofc T.\index[people]{van’t Hofc T.} and Den Hartog C.\index[people]{Den Hartog C.} 2000. \emph{Importance of Mangroves, Seagrass Beds and the Shallow Coral Reef as a Nursery for Important Coral Reef Fishes, Using a Visual Census Technique}. Estuarine,
Coastal and Shelf Science 51, 31–44 doi:10.1006/ecss.2000.0617 \pageref{Nagelkerken00}
\bibitem{Noralez10}
Noralez S.\index[people]{Noralez S.} 2010. \emph{Exploring the Limits of Mapping Seagrass. A case study for P. oceanica}. MSc Thesis. ITC. Netherlands. \pageref{Noralez10}
\bibitem{Norris97}
Norris J.G.\index[people]{Norris J.G.}, Wyllie-Echeverria S.\index[people]{Wyllie-Echeverria S.}, Mumford T.\index[people]{Mumford T.}, Bailey A.\index[people]{Bailey A.} and Turner T.\index[people]{Turner T.} 1997. \emph{Estimating basal area coverage of subtidal seagrass beds using underwater videography}.
...
\bibitem{Orth06}
Orth R.J.\index[people]{Orth R.J.}, Carruthers T.J.B.\index[people]{Carruthers T.J.B.}, Dennison W.C.\index[people]{Dennison W.C.}, Duarte C.M.\index[people]{Duarte C.M.}, Fourqurean J.W.\index[people]{Fourqurean J.W.}, Heck Jr.K. L.\index[people]{Heck Jr.K. L.}, Hughes A. R.\index[people]{Hughes A. R.}, Kendrick G. A.\index[people]{Kendrick G.A.}, Kenworthy W. J.\index[people]{Kenworthy W. J.}, Olyarnik S.\index[people]{Olyarnik S.}, Short F.T.\index[people]{Short F.T}, Waycott M.\index[people]{Waycott M.} and Williams S. L.\index[people]{Williams S.L.} 2006. \emph{A Global Crisis for Seagrass Ecosystems}. Vol. 56 No. 12, BioScience 987. \pageref{Orth06}
\bibitem{Palandro03}
Palandro D.\index[people]{Palandro D.}, Andr\'efou\"et S.\index[people]{Andr\'efou\"et S.}, Muller-Karger F. E.\index[people]{Muller-Karger F. E.}, Dustan Ph.\index[people]{Dustan Ph}, Hu Ch.\index[people]{Hu Ch.}, and Hallock P.\index[people]{Hallock P.} 2003. \emph{Detection of changes in coral reef communities using Landsat-5 TM and Landsat-7 ETM+ data}. Can. J. Remote Sensing, Vol. 29, No. 2, pp. 201–209. \pageref{Palandro03}
\bibitem{Pasqualini98a}
Pasqualini V.\index[people]{Pasqualini V.}, Pergent-Martini C.\index[people]{Pergent-Martini C.} and Pergent, G.\index[people]{Pergent G.} 1998(a). \emph{Use of remote sensing for the characterization of the Mediterranean coastal environment – the case of Posidonia
...
Pasqualini V.\index[people]{Pasqualini V.}, Pergent-Martini C.\index[people]{Pergent-Martini C.}, Clabaut P.\index[people]{Clabaut P.}, Pergent G.\index[people]{Pergent G.} 1998(b). \emph{Mapping of \textit{{Posidonia oceanica}} using aerial photographs and side scan sonar: Application off the
island of Corsica (France)}. Estuarine Coastal Shelf Sci 47:359–367. \pageref{Pasqualini98b}
\bibitem{Pasqualini99}
Pasqualini V.\index[people]{Pasqualini V.}, Pergent-Martini C.\index[people]{Pergent-Martini C.}, Pergent G.\index[people]{Pergent G.} 1999. \emph{Environmental impact identification along the Corsican coast (Mediterranean Sea) using image processing}. Aquatic Botany,
65:311-320. \pageref{Pasqualini99}
\bibitem{Pasqualini01}
Pasqualini V.\index[people]{Pasqualini V.}, Pergent-Martini C.\index[people]{Pergent-Martini C.}, Clabaut P.\index[people]{Clabaut P.}, Marteel H.\index[people]{Marteel H.}, and Pergent G.\index[people]{Pergent G.} 2001. \emph{Integration of Aerial Remote Sensing, Photogrammetry, and GIS Technologies in Seagrass
...
Pasqualini V.\index[people]{Pasqualini V.}, Pergent-Martini C.\index[people]{Pergent-Martini C.}, Pergent G.\index[people]{Pergent G.}, Agreila M.\index[people]{Agreila M.}, Skoufas G.\index[people]{Skoufas G.}, Sourbes L.\index[people]{Sourbes L.} and Tsirika A.\index[people]{Tsirika A.} 2005. \emph{Use of SPOT 5 for mapping seagrasses: An application to Posidonia oceanica}. Remote Sensing of Environment, 94:39-45. \pageref{Pasqualini05}
\bibitem{Peneva08}
Peneva E.\index[people]{Peneva E.I.}, Griffith J.A.\index[people]{Griffith J.A.} and Carter G.A.\index[people]{Carter G.A.} 2008. \emph{Seagrass Mapping in the Northern Gulf of Mexico using Airborne Hyperspectral Imagery: A Comparison of Classification Methods}. Journal of Coastal Research, Number 244:850-856. 2008. Published By: Coastal Education and Research Foundation DOI: 10.2112/06-0764.1 \pageref{Peneva08}
\bibitem{Peneva07}
Peneva E.I.\index[people]{Peneva E.I.}, Griffith J.A.\index[people]{Griffith J.A.} and Carter G.A.\index[people]{Carter G.A.} 2007. \emph{Mapping seagrass distribution on Horn Island}, MS using hyperspectral imagery.
\href{ftp://ftp.ecn.purdue.edu/jshan/proceedings/asprs2005/Files/0134.pdf}{ecn.purdue.edu} \pageref{Peneva07}
\bibitem{Pergent90}
Pergent G.\index[people]{Pergent G.} 1990. \emph{Lepidochronological analysis of the seagrass \textit{{Posidonia oceanica}} (L.)
...
Pergent-Martini C.\index[people]{Pergent-Martini C.}, Pasqualini V.\index[people]{Pasqualini V.}, Ferrat L.\index[people]{Ferrat L.} and Pergent G.\index[people]{Pergent G.} 2006. \emph{Ecological Data in Integrated Coastal Zone Management: Case Study of \textit{{Posidonia oceanica}} Meadows Along
...
Pergent-Martini C.\index[people]{Pergent-Martini C.}, Leoni V.\index[people]{Leoni V.}, Pasqualini V.\index[people]{Pasqualini V.}, Ardizzone G.D.\index[people]{Ardizzone G.D.}, Balestri E.\index[people]{Balestri E.}, Bedini R.\index[people]{Bedini R.}, Belluscio A.\index[people]{Belluscio A.}, Belsher T.\index[people]{Belsher T.}, Borg J.\index[people]{Borg J.}, Boudouresque C.F.\index[people]{Boudouresque C.F.}, Boumaza S.\index[people]{Boumaza S.}, Bouquegneau J.-M.\index[people]{Bouquegneau J.-M.}, Buia M.C.\index[people]{Buia M.C.}, Calvo S.\index[people]{Calvo S.}, Cebrian J.\index[people]{Cebrian J.}, Charbonnel E.\index[people]{Charbonnel E.}, Cinelli F.\index[people]{Cinelli F.}, Cossu A.\index[people]{Cossu A.}, Di Maida G.\index[people]{Di Maida G.}, Dural B.\index[people]{Dural B.}, Francour P.\index[people]{Francour P.}, Gobert S.\index[people]{Gobert S.}, Lepoint G.\index[people]{Lepoint G.}, Meinesz A.\index[people]{Meinesz A.}, Molenaar H.\index[people]{Molenaar H.}, Mansour H.M.\index[people]{Mansour H.M.}, Panayotidis P.\index[people]{Panayotidis P.}, Peirano A.\index[people]{Peirano A.}, Pergent G.\index[people]{Pergent G.}, Piazzi L.\index[people]{Piazzi L.}, Pirrotta M.\index[people]{Pirrotta M.}, Relini G.\index[people]{Relini G}, Romero J.\index[people]{Romero J.}, Sanchez-Lizaso J.L.\index[people]{Sanchez-Lizaso J.L.}, Semroud R.\index[people]{Semroud R.}, Shembri P.\index[people]{Shembri P.}, Shili A.\index[people]{Shili A.}, Tomasello A.\index[people]{Tomasello A.}, Velimirov B.\index[people]{Velimirov B.} 2005. \emph{Descriptors of \textit{{Posidonia oceanica}} meadows: Use and application}. Ecological Indicators 5, 213–230. \pageref{Pergent-Martini05}
\bibitem{Phinn08}
Phinn S.\index[people]{Phinn S.}, Roelfsema C.\index[people]{Roelfsema C.}, Dekker A.\index[people]{Dekker A.G.}, Brando V.E.\index[people]{Brando V.E.}, Anstee J.M.\index[people]{Anstee J.M.} 2008. \emph{Mapping seagrass species, cover and biomass in shallow waters: An assessment of satellite multi-spectral and airborne
hyperspectral imaging systems in Moreton Bay (Australia)}. Remote Sensing of Environment, 112:3413-3425. \pageref{Phinn08}
\bibitem{Ralph05}
Ralph P.J.\index[people]{Ralph P.J.}, Macinnis-Ng C.M.O.\index[people]{Macinnis-Ng C.M.O.}, Frankart C.\index[people]{Frankart C.} 2005. \emph{Fluorescence imaging application: effect of leaf age on seagrass photokinetics}. Aquatic Botany 81 (2005) 69–84. \pageref{Ralph05}
\bibitem{Rasib97}
Rasib A.W.\index[people]{Rasib A.W.} and Hashim M.\index[people]{Hashim M.} 1997. \emph{Mapping Seagrass From Satellite Remote Sensing
Data. Proceedings of Asian Conference on Remote Sensing}. \href{http://eprints.utm.my/2161/}{eprints.utm.my} \pageref{Rasib97}
\bibitem{Ribed02}
Ribed P.S.\index[people]{Ribed P.S.} 2002. \emph{Submarine vegetation studies using remote sensing: importance in beach measurements}. Journal of Environmental Protection and Ecology, 3 No 4, 953-958 (2002) \pageref{Ribed02}
\bibitem{Richardson06}
Richardson L.L.\index[people]{Richardson L.L.}, LeDrew Ellesworth F.\index[people]{LeDrew E.F.} 2006. \emph{Remote Sensing of Aquatic Costal
Ecosystems Processes}. Springer. Science and Management Applications. \pageref{Richardson06}
\bibitem{Robbins94}
Robbins B.D.\index[people]{Robbins B.D.}, Bell S.S.\index[people]{Bell S.S.} 1994. \emph{Seagrass landscapes: a terrestrial approach to the marine
subtidal environment}. TREE vol.9, no 8, doi:10.1016/0169-5347(94)90041-8 \pageref{Robbins94}
\bibitem{Sabins97}
Sabins F.\index[people]{Sabins F.} 1997. \emph{Remote Sensing, Principles and Interpretation}. W.H. Freeman and
Company, New York. \pageref{Sabins97}
\bibitem{Schmidt03}
Schmidt K.\index[people]{Schmidt K.} and Skidmore A.K.\index[people]{Skidmore A.K.} 2003. \emph{Spectral discrimination of vegetation types in a
coastal wetland}. Remote Sensing of Environment. 85:92-108. \pageref{Schmidt03}
\bibitem{Schmieder97}
Schmieder K.\index[people]{Schmieder K.} 1997. \emph{Littoral zone - GIS of Lake Constance: a useful tool in lake
monitoring and autecological studies with submersed macrophytes}. Aquatic Botany 58
(1997) 333-346 \pageref{Schmieder97}
\bibitem{Schultz08}
Schultz S.T.\index[people]{Schultz S.T.} 2008. \emph{Seagrass monitoring by underwater videography: Disturbance
regimes, sampling design, and statistical power}. Aquatic Botany 88 (2008) 228–238. \pageref{Schultz08}
\bibitem{Short01}
Short F.T.\index[people]{Short F.T.} and Coles R.G.\index[people]{Coles R.G.} (eds). 2001. \emph{Global Seagrass Research Methods}, p 482.
Elsevier Publishing Co., Amsterdam \pageref{Short01}
\bibitem{Shortis07}
Shortis M.\index[people]{Shortis M.}, Harvey E.\index[people]{Harvey E.}, Seager J.\index[people]{Seager J.} 2007. \emph{A Review of the Status and Trends in Underwater Videometric Measurement}. SPIE Conference 6491, Videometrics IX,IS and T/SPIE Electronic Imaging, San Jose, California, U.S.A., 28 January–1 February 2007 \pageref{Shortis07}
\bibitem{Stephens03}
Stephens F.C.\index[people]{Stephens F.C.}, Louchard E.M.\index[people]{Louchard E.M.}, Reid R.P.\index[people]{Reid R.P.}, Maffione R.A.\index[people]{Maffione R.A.} 2003. \emph{Effects of microalgal communities on reflectance spectra of carbonate sediments in subtidal optically shallow
marine environments}. Limnology and Oceanography, 48:535-546. \pageref{Stephens03}
\bibitem{Thorhaug07}
Thorhaug, A.\index[people]{Thorhaug, A.}, Richardson, A. D.\index[people]{Richardson, A.D.} and Berlyn, G.P.\index[people]{Berlyn, G.P.} 2007. \emph{Spectral reflectance of the seagrasses: Thalassia testudinum, Halodule wrightii, Syringodium filiforme and five marine
algae}. International Journal of Remote Sensing, 28: 7, 1487 — 1501. \pageref{Thorhaug07}
\bibitem{Toole00}
Toole D.A.\index[people]{Toole D.A.}, Siegel D.A.\index[people]{Siegel D.A.}, Menzies D.W.\index[people]{Menzies D.W.}, Neumann M.J.\index[people]{Neumann M.J.} and Smith R.C.\index[people]{Smith R.C.} 2000. \emph{Remote-sensing reflectance determinations in the coastal ocean environment: impact of instrumental characteristics and environmental variability}. Applied Optics 39(3), 456-469. \pageref{Toole00}
\bibitem{Vahtmae06}
Vahtmae E.\index[people]{Vahtmae E.}, Kutser T.\index[people]{Kutser T.}, Martin G.\index[people]{Martin G.}, Kotta J.\index[people]{Kotta J.}, 2006. \emph{Feasibility of hyperspectral remote sensing for mapping benthic macroalgal cover in turbid coastal waters - a Baltic Sea case
study. Remote Sensing of Environment} (2006) 101:342-351. \pageref{Vahtmae06}
\bibitem{Vahtmae07}
Vahtmae E.\index[people]{Vahtmae E.} and Kutser T.\index[people]{Kutser T.} 2007. \emph{Mapping bottom type and water depth in shallow
...
\bibitem{Villegas06}
Villegas P. P.\index[people]{Villegas P. P.} 2006. \emph{Magnitude of herbivory in \textit{Posidonia oceanica} (L.) Delile and
...
\bibitem{Wabnitz08}
Wabnitz C.C.\index[people]{Wabnitz C.C.}, Andr\'efou\"et S.\index[people]{Andr\'efou\"et S.}, Torres-Pulliza D.\index[people]{Torres-Pulliza D.}, M\"uller-Karger F. E.\index[people]{M\"uller-Karger F. E.} and Kramer P.A.\index[people]{Kramer P.A.}, 2008. \emph{Regional-scale seagrass habitat mapping in the Wider Caribbean region using Landsat sensors: Applications to conservation and ecology}. Remote Sensing of Environment Vol. 112, Issue 8, 15 August 2008, Pages 3455-3467 Earth Observations for Marine and Coastal Biodiversity and Ecosystems Special Issue. \pageref{Wabnitz08}
\bibitem{Walker89}
Walker, D.I.\index[people]{Walker, D.I.}, 1989. \emph{Methods for monitoring seagrass habitat}. Proceedings Rep. Workshop, 20-22 June 1988, Melbourne, Australia, VIMS Working Paper 18, pp. 1-26. \pageref{Walker89}
\bibitem{Werdell03}
Werdell P.J.\index[people]{Werdell P.J.} and Roesler C.S.\index[people]{Roesler C.S.} 2003. \emph{Remote assessment of benthic substrate composition
in shallow waters using multispectral reflectance}. Limnol. Oceanogr., 48 (1, part 2), 557–567 \pageref{Werdell03}
\bibitem{Yang10}
 Yang Ch.\index[people]{Yang Ch.}, Yang D.\index[people]{Yang D.}, Cao W.\index[people]{Cao W.}, Zhao J.\index[people]{Zhao J.}, Wang G.\index[people]{Wang G.}, Sun Zh.\index[people]{Sun Zh.}, Xu Zh.\index[people]{Xu Zh.}, Kumar M. S. R.\index[people]{Kumar M. S. R.} 2010. 
...
%\markright{List of People}
%\addcontentsline{toc}{section}{List of People}
...
%%%%%%%%%%%%%%%%%%%%%%%%% End Polina Lemenkova's MSc Thesis Document %%%%%%%%%%%%%%%%%%%%%%%%%%%%
