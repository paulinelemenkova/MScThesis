...
\href{http://www.spectrapartners.nl/}{SpectraPartners}, etc. Trios-RAMSES\index{Seawater optical properties!spectroradiometers!Trios-RAMSES} hyperspectral radiometers
...
We briefly discuss below the most effective RTM software and algorithms from a range of various best-known up-to-date tools. 
	\begin{itemize}
		\item [*] The \textit{Second Simulation of a Satellite Signal in the Solar Spectrum}, version 1 \href{http://6s.ltdri.org/}{(6SV1)}\index{Seawater optical properties!RTM!6SV1} is a US atmospheric correction algorithm, developed in the University of Maryland; adjusted for the \href{http://modis.gsfc.nasa.gov/}{NASA MODIS} satellite imagery lookup tables. The 6S algorithm has been implemented by the \href{http://grass.osgeo.org/grass64/manuals/html64_user/i.atcorr.html}{GRASS} software for the atmospheric correction 						\pagebreak				 
		\item [*] Another example of the RTM adjusted for a specific imagery is a German \href{http://www.imk-asf.kit.edu/english/312.php}{\textit{KOPRA RTM}}\index{Seawater optical properties!RTM!KOPRA}, fitted for \href{http://envisat.esa.int/instruments/meris/}{MIPAS/ENVISAT} imagery.
...
managed and treated using integrated GIS approach, as, e.g. reported by Schmieder \cite{Schmieder97}\label{Schmieder97}.
...
The underwater videography\index{Remote sensing!underwater videography} with a GPS\index{Remote sensing!GPS} is a tool of seagrass monitoring which has certain advantages, i.e.
...
The Landsat TM\index{Remote sensing!multispectral imagery!Landsat TM} and Landsat ETM+\index{Remote sensing!multispectral imagery!Landsat ETM+} data, with the most recent from sensor Landsat 7 - an advanced
...
Another well-known multispectral sensor, SPOT\index{Remote sensing!multispectral imagery!SPOT} provides multispectral imagery with a spatial
...
made using IKONOS, Landsat TM, and CASI\index{Remote sensing!multispectral imagery!CASI}, show that in the blue part of the
...
landscapes. Thus, CASI and Quickbird-2\index{Remote sensing!multispectral imagery!Quickbird} images enable to identify even separate seagrass species
...
Advanced Spectrometer for Thermal Emission and Reflection Radiometer (\href{http://asterweb.jpl.nasa.gov/}{ASTER}\index{Remote sensing!multispectral imagery!ASTER}), launched in
...
UVA/UVB Irradiance Sensor and RAMSES-ARC Hyperspectral UV-VIS Radiance Sensor (Fig. \ref{fig:2.1}), both adjusted for the measurements of the irradiance and radiance (see \nameref{app}: Tab. \ref{tab:A.1}, Tab. \ref{tab:A.2}). \\
...
St Dev: Standard deviation\index{Data!statistical analysis!standard deviation}, STDEV{data}
...
types as the different sensors would percept them: MODIS\index{Remote sensing!multispectral imagery!MODIS}, ASTER\index{Remote sensing!multispectral imagery!ASTER}, MERIS\index{Remote sensing!multispectral imagery!MERIS}, SeaWiFS\index{Remote sensing!multispectral imagery!SeaWiFS} and CZCS\index{Remote sensing!multispectral imagery!CZCS}.\\
...
To make further studies of \textit{P.oceanica} more effective we would suggest the following recommendations to be considered by the future researchers:
	\begin{description}
		...
		\item[Eighth:] Application of various open source GIS (ILWIS, GRASS) could be very useful for the validation of the cartographic results, assessment of accuracy and comparison of various classification methods. 
		...
		\item[Tenth:] A flexible combination of the multi-scale mapping and results of the fieldwork measurements with GPS-referenced underwater footage would enable more profound analysis of the coastal environment on Crete. 
	\end{description}
