...
\begin{titlepage}
	...
	\affil[1]{\textit{University of Twente, Faculty of Geo-Information Science and Earth Observation (ITC)}, The Netherlands}
	\date{\today}
	\maketitle	
\end{titlepage}
\pagebreak
...
\vspace{1mm}\\
Many thanks for Dr. \author{\textit{Dingtian Yang}} from the South China Sea Institute of Oceanology, our colleague in problem of seagrass monitoring and research, for his handing over the data of spectral reflectance of Thalassia seagrass, which enabled to compare spectra of various seagrass types. 
...
\section*{List of Tools}\label{sec:0}
	...
	\addcontentsline{toc}{section}{List of Tools}\index{Software used}
...
\cite{McKenzie08}\label{McKenzie08}. Seagrasses\index{Seagrasses} create unique, complex, extremely diversified and productive ecological systems in the
...
Globally, there are 58 recognized and described seagrass species\index{Seagrasses!global species} (Fig. \ref{fig:2}), belonging to two orders
...
include climate (mostly, tropical and temperate areas\index{Seagrasses!distribution of}), bathymetry (shallow shelf zones), hydrological
...
There are four European seagrass species \index{Seagrasses!Mediterranean species} in Mediterranean area \cite{Borum04}\label{Borum04}: \textit{Zostera marina,
...
Meadows of \textit{P. oceanica} are subjected to the human activities\index{Seagrasses!ecological vulnerability}, as they occur in coastal areas, where
...
e.g. thermal, sewage, dredging and chemical pollution\index{Seagrasses!anthropogenic impacts on}  as well as any other kind of maritime works,
...
Besides anthropogenic factors, various biochemical, climatic and environmental processes\index{Seagrasses!natural impacts on} can cause
...
\subsubsection{General characteristics of \textit{P.oceanica}}\index{Seagrasses!\textit{P.oceanica}}
...
spatially restricted to the Mediterranean area\index{Seagrasses!\textit{P.oceanica}!distribution} (Fig.\ref{fig:5}), 
...
Morphologically\index{Seagrasses!\textit{P.oceanica}!morphology}, \textit{P.oceanica} consists of long, 5-12 mm broad, “hairy-like” leaves, 3-4 mm thick roots and short rhizomes (0.5-2.0 mm). 
...
The adaptation\index{Seagrasses!\textit{P.oceanica}!environmental adaptation}
...
The phenology\index{Seagrasses!\textit{P.oceanica}!phenology} of \textit{P.oceanica} is also affected by the coastal bathymetry: in the isolated meadows in shallow waters plants have shorter and falciform leaves, compared to ones in the deeper and central
...
\subsection{Research problem}\index{Research}
Monitoring\index{Research!problem} of the marine benthic ecosystems of seagrasses is essential for the environmental
...
\subsection{Research objective}\index{Research!objective}
...
from the following sources \index{Data}:
	\begin{itemize}
...
\subsubsection{General objective}\index{Research!objective!general}
...
\subsubsection{Specific objectives}\index{Research!objective!specific}
	\begin{itemize}	
...
\subsection{Research questions}\index{Research!questions}
	\begin{itemize}	
...
\subsection{Hypotheses testing}\index{Research!questions!hypothesis}
...
\subsection{Research approach}\index{Research!approach}
...
\subsection{Seagrass global monitoring: history and perspectives}\index{Seagrasses!global monitoring}
...
Several global seagrass surveys\index{Seagrasses!global surveys} organize and provide regular monitoring of the seagrass distribution,
...
The optical properties\index{Seawater optical properties} of the sea water vary with different environmental conditions and reflect
...
remote sensing\index{Seawater optical properties!hyperspectral measurements} and reinforce other processes \cite{Maffione01b}\label{Maffione01b}. Thus, waves and tides increase
...
The irradiance\index{Seawater optical properties!irradiance} and radiance\index{Seawater optical properties!radiance} of the water thus should be measured, in order to estimate spectral
...
optical sensors spectroradiometers\index{Seawater optical properties!spectroradiometers}. There are several companies producing radiometers with various
...
\href{http://www.spectrapartners.nl/}{SpectraPartners}, etc. \ac{Trios-RAMSES}\index{Seawater optical properties!spectroradiometers!Trios-RAMSES} hyperspectral radiometers
...
We briefly discuss below the most effective RTM software and algorithms from a range of various best-known up-to-date tools. 
	\begin{itemize}
		\item [*] The \ac{6SV1} \index{Seawater optical properties!RTM!6SV1} is a US atmospheric correction algorithm, developed in the University of Maryland; adjusted for the \ac{MODIS} satellite imagery lookup tables. The 6S algorithm has been \href{http://grass.osgeo.org/grass64/manuals/html64_user/i.atcorr.html}{implemented} by the \ac{GRASS} software for the atmospheric correction 				 
		\item [*] Another example of the RTM adjusted for a specific imagery is a German \ac{KOPRA}\index{Seawater optical properties!RTM!KOPRA}, fitted for \ac{MIPAS} and \ac{ENVISAT} imagery.
		...
		\item [*] The British \ac{RTTOV-9}\index{Seawater optical properties!RTM!RTTOV-9} is a radiative transfer model, developed for nadir viewing atmospheric sounders and imagers. It includes a number of useful tolls, e.g. can compute sea-surface emissivity for each channel, enables, to specify cloudiness for radiance calculations, etc.  This program runs under Unix/Linux platforms and is open source. 
		\item [*] The \ac{RRTM}\index{Seawater optical properties!RTM!RRTM} is one more RTM freeware, designed in the USA, Massachusetts. 
		\item [*] The \href{http://www.modtran.org/}{\textit{MODTRAN}}\index{Seawater optical properties!RTM!MODTRAN}, a commercial software from Spectral Sciences Inc., is another example of the RTM. Among its newest updates is generation of atmospheric correction data; it also has an option to write spectral output in binary, and convert it to \ac{ASCII}.
		\item [*] A \ac{DISORT}\index{Seawater optical properties!RTM!DISORT}  is another RTM freeware , developed as an algorithm for calculation radiance of the scattering and absorbing Earth's atmosphere and transmissivity computations within the waveband range from UV to radar.  
		\item [*] The \ac{CRTM} \index{Seawater optical properties!RTM!CRTM} is designed by the  (\href{http://www.jcsda.noaa.gov/}{JCSDA}, \ac{NASA}) and includes Surface Emissivity/Reflectivity Models, Cloud Absorption/Scattering Model and Gaseous Absorption Model.
		\item [*] An \ac{4AOP}\index{Seawater optical properties!RTM!4AOP} is a French RTM freeware, designed in cooperation by \href{http://www.noveltis.fr/fr/index.php}{Noveltis} and \href{http://www.cnes.fr/}{the French Space Agency} (\ac{CNES}). Being a fine program which enables accurate computations of the radiance, defining other emissivity functions and other set up, it is however, particularly designed for the infrared waves (thus, not quite suitable in our case). To the advantages of this freeware we would count its user friendly interface and open source accessibility for the academic purposes. 
	\end{itemize}
For our purpose we have chosen the \ac{WASI}\index{Seawater optical properties!RTM!WASI} \ac{RTM} software, due to its effectiveness, adaptability for the Mediterranean environment, open source availability, coverage of necessary wavebands and clear, user friendly interface, enabling to adjust various environmental parameters.
...
\subsection[Application of the remote sensing...]{Application of the remote sensing data towards seagrass mapping}\index{Remote sensing}
...
The underwater videography\index{Remote sensing!underwater videography} with a \ac{GPS}\index{Remote sensing!GPS} is a tool of seagrass monitoring which has certain advantages, i.e.
...
Spectral measurements\index{Remote sensing!spectral measurements} of the target objects are made
...
Studies of spectral reflectance\index{Seawater optical properties!spectral reflectance} of the different seagrass species comparing to the spectra of sand and
...
Spectral reflectance\index{Seawater optical properties!spectral reflectance} of the seagrass  (Fig.\ref{fig:13}) is largely influenced by the water
depth where it is located, and is generally decreasing in values by increasing depths.
The most important spectral diapason\index{Seawater optical properties!spectral reflectance!spectral diapason} for marine mapping of submerged vegetation
...
\subsubsection[Review of multispectral imagery...]{Review of multispectral imagery used for seagrass mapping}\label{sec:2.4.1}\index{Remote sensing!multispectral imagery} 
...
The \ac{Landsat TM}\index{Remote sensing!multispectral imagery!Landsat TM} and \ac{Landsat ETM+}\index{Remote sensing!multispectral imagery!Landsat ETM+} data, with the most recent from sensor Landsat 7 - an advanced
...
Another well-known multispectral sensor, \ac{SPOT}\index{Remote sensing!multispectral imagery!SPOT} provides multispectral imagery with a spatial
...
The \href{http://www.satimagingcorp.com/gallery-ikonos.html}{IKONOS}\index{Remote sensing!multispectral imagery!IKONOS}, offering multispectral and panchromatic imagery, was the first to collect publicly
...
made using IKONOS, \ac{Landsat TM}, and \ac{CASI}\index{Remote sensing!multispectral imagery!CASI}, show that in the blue part of the
...
landscapes. Thus, \ac{CASI} and Quickbird-2\index{Remote sensing!multispectral imagery!Quickbird} images enable to identify even separate seagrass species
...
\ac{ASTER}\index{Remote sensing!multispectral imagery!ASTER}), launched in
1999 on board Terra sensor\index{Remote sensing!multispectral imagery!Terra sensor}, provides high-resolution images of the Earth in 15 different bands of the
...
\subsubsection[Review of hyperspectral imagery...]{Review of hyperspectral imagery used for seagrass mapping}\label{sec:2.4.2}\index{Remote sensing!hyperspectral imagery}
...
overall accuracies \cite{Phinn08}\label{Phinn08}. Several, regular and narrow (10 nm) spectral bands\label{sec:2.4.2}\index{Remote sensing!hyperspectral imagery!spectral bands}, specific for
...
Comparative analysis of the application of hyperspectral\label{sec:2.4.2}\index{Remote sensing!hyperspectral imagery!application} and multispectral imagery towards the
...
\subsection{Fieldwork data collection}\index{Data!collection}
...
\subsection{Data pre-processing}\index{Data!pre-processing}
...
\subsubsection{Water color spectral simulation using WASI}\index{Data!processing}
...
types, where the spectral signatures were examined. WASI software\index{Seawater optical properties!RTM!WASI} (Fig.\ref{fig:4.7}) is used to simulate
...
An analysis of the spectral reflectance of \textit{P.oceanica} is done using the WASI simulations\index{Seawater optical properties!RTM!WASI} in order to
...
\subsubsection{Statistical analysis of the observational data and hypothesis testing}\index{Data!statistical analysis}
...
The statistical calculators were mainly made by means of Gretle\index{Data!statistical analysis!Gretl} and SPSS\index{Data!statistical analysis!SPSS}. 
...
Each time we observe the outcome of a random variable\index{Data!statistical analysis!variables} of spectral reflectance, we obtain an observation, which is hence no longer random. 
...
A probability distribution\index{Data!statistical analysis!probability distribution}, a mathematical statement about the possible values that the random observations of spectral reflectance can take on, displays the relative frequency with which each possible value of spectral reflectance is observed. 
The \textit{least absolute deviations (LAD)}\index{Data!statistical analysis!LAD}, a popular optimization technique, were used to show the main trend of the distribution of spectral reflectance values along the spectra (Tab.\ref{tab:12}). Non-linear logistic analysis\index{Data!statistical analysis!non-linear logistic analysis} is applied to specify and estimate a model of spectral distribution, in which the dependent variable (i.e. the value of spectral reflectance for each single observation) is not continuous, but discrete and independent for each case (Tab.\ref{tab:11}). \\
As the observations were made in a repeated way, we also analyzed the data pool using autocorrelation as well: Tab.\ref{tab:13} and Tab.\ref{tab:14} for \textit{P.oceanica} and Tab.\ref{tab:28} for carbonate sand. The \textit{autocorrelation}\index{Data!statistical analysis!autocorrelation}, a cross-correlation\index{Data!statistical analysis!cross-correlation} of an observed value with itself, made on two different days (14th and 15th October), shows the similarity between observations as a function of the time separation between them. 
...
The method of \textit{least squares}\index{Data!statistical analysis!least squares, method of} minimizes the sum of the squares of the errors made in solving every single observation made. We tried different approaches of the \textit{least squares} methods: Tab.\ref{tab:15}, Tab.\ref{tab:18}, Tab.\ref{tab:27}.\\
...
The \textit{k-means cluster analysis}\index{Data!statistical analysis!k-means cluster analysis} has been used for partitioning observation sets into k clusters (Tab.\ref{tab:20}, Tab.\ref{tab:21}, Tab.\ref{tab:22}, Tab.\ref{tab:23}) in which each observation belongs to the cluster with the nearest mean.
It enables to highlight the main areas of the location of values of spectral reflectance along the spectra.\\
To estimate spectral density of a spectral reflectance measurements we used periodogram\index{Data!statistical analysis!periodogram} function (Tab.\ref{tab:30}), 
which corresponds to the general spectrum of the observations with representation of a variable quantity.  
Thus, the periodogram (Fig. \ref{fig:A.31}) of the series of observation\index{Data!statistical analysis!observations, series of} highlights so-called “dead spots” of low power between the frequencies we wish to
...
areas of quartiles\index{Data!statistical analysis!quartiles Q1-Q3} (Q1, Q3, shaded areas on graph, Fig. \ref{fig:4.10}, Fig.\ref{fig:4.14}), which cover most probable data distribution
...
A statistical hypothesis\index{Data!statistical analysis!hypothesis testing} test has been applied for the making decision and controlling the wealth of the
...
\paragraph{ANOVA-testing}\index{Data!statistical analysis!ANOVA}
...
\paragraph{Student-t testing}\index{Data!statistical analysis!Student-t testing}
...
Mean: Average of the data to be plotted, AVERAGE\index{Data!statistical analysis!average} {data}
St Dev: Standard deviation\index{Data!statistical analysis!standard deviation}, \ac{STDEV} {data}
...
50th Pct: Plotting value of median = Median\index{Data!statistical analysis!median}-Q1
...
types as the different sensors would percept them: MODIS\index{Remote sensing!multispectral imagery!MODIS}, ASTER\index{Remote sensing!multispectral imagery!ASTER}, MERIS\index{Remote sensing!multispectral imagery!MERIS}, SeaWiFS\index{Remote sensing!multispectral imagery!SeaWiFS} and \ac{CZCS}\index{Remote sensing!multispectral imagery!CZCS}.\\
...
Seagrass beds are clearly visible in color aerial Google Earth\index{Remote sensing!aerial imagery!GoogleEarth}
...
\subsubsection{Data integration}\index{Data!integration}
...
spectral signatures using WASI software\index{Seawater optical properties!RTM!WASI}, image processing by means of Erdas Imagine (Fig.\ref{fig:39}) and Arc GIS
...
\subsubsection{Upscale mapping of the seagrass landscapes}\index{Seagrasses!spatial structure}
...
\bibitem{Dehouck08}
Dehouck A., Martiny N., Froidefond J.-M., S\'en\'echal N. 2008. \emph{In-Water Reflectance
...
(\textit{Posidonia oceanica}) fish farm-induced decline}. \href{http://arxiv.org/ftp/qbio/
...
Frederiksen M, Grau A, Karakassis I, Marbà N, Mirto S, Pérez M, Pusceddu A, Tsapakis M.2008
...
\href{http://www.seagrasswatch.org}{seagrasswatch} \pageref{McKenzieetal03}
\bibitem{McKenzie06}
...
\bibitem{Wabnitz08}
Wabnitz C.C., Andréfouët S., Torres-Pulliza D., M\"uller-Karger F. E. and Kramer P.A.
