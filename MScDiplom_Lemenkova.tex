...
\subsection[Application of the remote sensing...]{Application of the remote sensing data towards seagrass mapping}\index[concepts]{Remote sensing}\label{page-15}
...
Spectral reflectance\index[concepts]{Seawater optical properties!spectral reflectance} of the seagrass  (Fig.\ref{fig:13})\label{page-17} is largely influenced by the water
...
\begin{figure}[h]
	...
	\caption{Main interface of \ac{WASI} water color spectral simulation: \\ Spectral reflectance of \textit{P.oceanica} and silt at 0.5-4.0m. Pages: $<$\pageref{page-35}$>$, $<$\pageref{page-31}$>$}
	\label{fig:4.7}
\end{figure}
