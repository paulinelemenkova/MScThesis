...
\begin{acronym}
	...
	\acro{6SV1}{Second Simulation of a Satellite Signal in the Solar Spectrum Version1} 
...
include climate (mostly, tropical and temperate areas\index[concepts]{Seagrasses!distribution of}), bathymetry (shallow shelf zones), hydrological
...
Meadows of \textit{P. oceanica} are subjected to the human activities\index[concepts]{Seagrasses!ecological vulnerability}, as they occur in coastal areas, where
...
Morphologically\index[concepts]{Seagrasses!\textit{P.oceanica}!morphology}, \textit{P.oceanica} consists of long, 5-12 mm broad, “hairy-like” leaves, 3-4 mm thick roots and short rhizomes (0.5-2.0 mm). 
...
\begin{figure}[H]
	...
	\caption{Morphology of \textit{P.oceanica}}\label{fig:8}
\end{figure}
...
\subsection[Measuring water optical properties]{Measuring water optical properties: \\hyperspectral radiometers}\label{sec:2-2}
...
Another well-known multispectral sensor, \ac{SPOT}\index[concepts]{Remote sensing!multispectral imagery!SPOT} provides multispectral imagery with a spatial resolution of 10 m, covering covers a surface area of 3600 km² (60*60 km swath), 26-day
...
\begin{wrapfigure}{r}{0.4\textwidth}
	...
	\caption{Multispectral vs. hyperspectral band coverage. Source: \cite{Sabins97}\label{Sabins97}}
	\label{fig:2.5}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.5\textwidth}
	...
	\caption{Combined plots of simulated remote sensing reflectance of \textit{P.oceanica} at various sensors: \ac{MODIS}, \ac{MERIS}, \ac{SeaWiFS} and \ac{CZCS}, iterated over three depths.}
	\label{fig:4.6}
\end{wrapfigure}
...
\subsubsection{Water color spectral simulation using WASI}\index[concepts]{Data!processing}
...
\begin{figure}[H]
	...
	\caption{Remote sensing reflectance of \textit{P.oceanica} at various depths, simulated for broadband sensors.}
	\label{fig:4.9}
\end{figure}
...
The statistical calculators were mainly made by means of Gretle\index[concepts]{Data!statistical analysis!Gretl} and SPSS\index[concepts]{Data!statistical analysis!SPSS}. 
...
We applied various methods of statistical analysis towards data pool (some examples of the selected tables are in the \nameref{app}: Tab.\ref{tab:18}, Tab.\ref{tab:24}, Tab.\ref{tab:25}, Tab.\ref{tab:26}, Tab.\ref{tab:29}), in order to analyze the distribution of values of spectral reflectance of \textit{P.oceanica}. 
...
To estimate spectral density of a spectral reflectance measurements we used periodogram\index[concepts]{Data!statistical analysis!periodogram} function (Tab.\ref{tab:30}), 
which corresponds to the general spectrum of the observations with representation of a variable quantity.  
Thus, the periodogram (Fig. \ref{fig:A.31}) of the series of observation\index[concepts]{Data!statistical analysis!observations, series of} highlights so-called “dead spots” of low power between the frequencies we wish to
...
areas of quartiles\index[concepts]{Data!statistical analysis!quartiles Q1-Q3} (Q1, Q3, shaded areas on graph, Fig. \ref{fig:4.10}, Fig.\ref{fig:4.14}), which cover most probable data distribution
...
A statistical hypothesis\index[concepts]{Data!statistical analysis!hypothesis testing} test has been applied for the making decision and controlling the wealth of the
...
types as the different sensors would percept them: MODIS\index[concepts]{Remote sensing!multispectral imagery!MODIS}, ASTER\index[concepts]{Remote sensing!multispectral imagery!ASTER}, MERIS\index[concepts]{Remote sensing!multispectral imagery!MERIS}, SeaWiFS\index[concepts]{Remote sensing!multispectral imagery!SeaWiFS} and \ac{CZCS}\index[concepts]{Remote sensing!multispectral imagery!CZCS}.\\
...
spectral signatures using \ac{WASI} software\index[concepts]{Seawater optical properties!RTM!WASI}, image processing by means of Erdas Imagine (Fig.\ref{fig:39}) and Arc \ac{GIS} based mapping. The use of \ac{GIS} for data incorporation (Fig.\ref{fig:4.17}), storage, analyses, visualizing and mapping
...
\subsubsection{Upscale GIS mapping of the seagrass landscapes}\index[concepts]{Seagrasses!spatial structure}
...
\subsection{\textit{Appendix-1} \footnote{The page where the illustration is explained in the main text of MSc thesis is given in angle brackets (e.g., $<$10$>$).}. Capturing aerial imagery from the Google Earth}
...
\subsection{\textit{Appendix-2}. Illustrations of some concepts and principles of the remote sensing, relevant for this work}
...
\subsection[\textit{Appendix-3}. Instrumental adjustment and tuning]{\textit{Appendix-3}. Instrumental adjustment and tuning \\ (Trios-RAMSES setup)}
%\appendixname{\textbf{2:\\ Instrumental adjustment and tuning (Trios-RAMSES setup)}}
...
\subsection{\textit{Appendix-4}. Results of videographic measurements: seafloor types on Crete island}
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Ligaria beach, Crete: seafloor types}\label{fig:A.5}
	\end{center}
\end{figure}
...
\subsection{\textit{Appendix-5}. Data pre-processing}
...
\subsection{\textit{Appendix-6}. Data processing and statistical evaluation: Results of the measurements of the seafloor optical properties.}
...
\begin{figure}[H]
	...
	\caption{Partial correlation analysis of the measurement set 1-16 of the spectral reflectance of \textit{P.oceanica} (15.X.). Visualization in \href{http://www.spss.com/}{SPSS}}
	\label{fig:A.22}
\end{figure}
\pagebreak
\newpage
...
%%%Gretl begin
\begin{table}[H]
	\caption{Results of the \textit{Principal Components Analysis}: measurement variables 1-7 from the selected dataset 301-325 of the spectral reflectance of \textit{P.oceanica} (15.X.). \href{http://gretl.sourceforge.net/}{Gretl}}
	\begin{center}
...
\begin{figure}[H]
	...
	\caption{Graph of the autocorrelation analysis of the measurements of carbonate sand. Series 51-75, variable 27. \href{http://gretl.sourceforge.net/}{Gretl} visualization­}
	\label{fig:A.29}
	\end{center}
\end{figure}
...
\begin{longtable}{|r|r|r|r|r|r|r|}
	\caption{Results of the statistical analysis of spectral reflectance of \textbf{carbonate sand}, with average values (for sets 1-3). Wavelength step: 3 nm. Measured on Agia Pelagia beach, 14th October}\label{tab:A.29} \\
 		 \multicolumn{1}{|l|}{\textbf{wl}} &
  		 \multicolumn{1}{l|}{\textbf{min}} & 
  		 \multicolumn{1}{l|}{\textbf{Q1}} & 
  		 \multicolumn{1}{l|}{\textbf{mean}} & 
...
\begin{figure}[H]
	...
	\caption{Spectral reflectance of carbonate sand on A.Pelagia beach. Results of single measurement set made by spectroradiometer Trios-RAMSES. \href{http://www.gnuplot.info/}{Gnuplot}}
	\label{fig:A.35}
\end{figure}
\pagebreak
\newpage

\subsection{\textit{Appendix-7}. Satellite and aerial images covering research area of Crete island: selected examples}
...
\subsection{\textit{Appendix-8}. Analysis and classification of the satellite and aerial images}
%\appendixname{\textbf{8:\\ Satellite and aerial images covering research area of Crete island: selected examples}}
...
\subsection{\textit{Appendix-9}. Research general workflow}
...
\subsection{\textit{Appendix-10}. Some snapshots of the working process}
...
\begin{figure}[H]
	...
	\caption{Adjusting waterproof Olympus cameras for underwater seafloor videometric measurements.\\Dr. \textit{Petros Lymberakis}\index[people]{Lymberakis, P.} (left) and Dr. \textit{Bert Toxopeus}\index[people]{Toxopeus, A.G.} (right)}
	\label{fig:A.48}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{photo-3.jpg}
	\caption{Sticking the marker into the seafloor bottom in mattte of \textit{P.oceanica} for depth measurements}
	\label{fig:A.48}
\end{figure}
