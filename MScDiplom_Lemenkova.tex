...
spatially restricted to the Mediterranean area\index{Seagrasses!\textit{P.oceanica}!distribution} (Fig.\ref{fig:5}), with its extension limited by the western part
...
Morphologically\index{Seagrasses!\textit{P.oceanica}!morphology}, \textit{P.oceanica} consists of long, 5-12 mm broad, “hairy-like” leaves, 3-4 mm thick roots
...
There are several environmental factors, determining the growth of the \textit{P.oceanica}. The adaptation\index{Seagrasses!\textit{P.oceanica}!environmental adaptation}
...
The phenology\index{Seagrasses!\textit{P.oceanica}!phenology} of \textit{P.oceanica} is also affected by the coastal bathymetry: in the isolated meadows in
...
remote sensing\index{Optical properties of the seafloor!hyperspectral measurements} and reinforce other processes \cite{Maffione01b}\label{Maffione01b}. Thus, waves and tides increase
