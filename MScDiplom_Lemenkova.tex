...
\restylefloat{figure}
\usepackage{hyperref}
\hypersetup{pdftitle={Seagrass mapping and monitoring along the coasts of Crete, Greece}, pdfauthor={Lemenkova Polina}, pdfsubject={MScThesis}, pdfcreator={Lemenkova Polina}, pdfproducer={Lemenkova Polina}, colorlinks=true,linkcolor=Navy, citecolor=Crimson, filecolor=magenta, urlcolor=blue}
...
\subsection{\textit{Appendix-1}. Capturing aerial imagery from the Google Earth: grabbing process}
%\appendixname{\textbf{1: \\Capturing aerial imagery from the Google Earth: grabbing process}}

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{Fig-22.jpg}
